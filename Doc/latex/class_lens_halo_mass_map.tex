...
An alternative way of using the output of a particle-\/based simulation is to use a \doxylink{class_lens_halo_particles}{Lens\+Halo\+Particles}.
...
{\em Mass\+Map} & mass map, resolution/range in radians, Pixel\+Map\+Units setting is ignored  \\
\hline
