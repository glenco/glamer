...
\DoxyCodeLine{00669\ \ \ \ \ }
\DoxyCodeLine{00670\ \ \ \ \ map.\mbox{\hyperlink{class_pixel_map_af2bf825f047bb394a80ff4f812e5fed8}{printFITS}}(\textcolor{stringliteral}{"{}!test\_concave.fits"{}});}
\DoxyCodeLine{00671\ \ \ \}}
\DoxyCodeLine{00672\ \ \ }
...
\DoxyCodeLine{00788\ \ \ \ \ \ \ }
\DoxyCodeLine{00789\ \ \ \ \ \ \ map.\mbox{\hyperlink{class_pixel_map_af2bf825f047bb394a80ff4f812e5fed8}{printFITS}}(\textcolor{stringliteral}{"{}!test\_concave.fits"{}});}
\DoxyCodeLine{00790\ \ \ \ \ \}}
\DoxyCodeLine{00791\ \ \ \}}
\DoxyCodeLine{00792\ \ \ }
...
\DoxyCodeLine{00976\ \ \ \textcolor{keywordflow}{if}(isnan(s)\ ||\ s<=0)\{}
...
\DoxyCodeLine{00993\ }
\DoxyCodeLine{00994\ \ \ \textcolor{keywordflow}{if}(isnan(s)\ ||\ s<=0)\{}
\DoxyCodeLine{00995\ \ \ \ \ closest\_point\ =\ S1;}
...
\DoxyCodeLine{00999\ \ \ \ \ closest\_point\ =\ S1\ +\ D*s;}
\DoxyCodeLine{01000\ \ \ \}}
\DoxyCodeLine{01001\ \ \ \textcolor{keywordflow}{return}\ (closest\_point\ -\/\ P).length();}
\DoxyCodeLine{01002\ \}}
\DoxyCodeLine{01003\ }
\DoxyCodeLine{01004\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Ptype>}
\DoxyCodeLine{01005\ \textcolor{keywordtype}{bool}\ segments\_cross(\textcolor{keyword}{const}\ Ptype\ \&a1,\textcolor{keyword}{const}\ Ptype\ \&a2}
\DoxyCodeLine{01006\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,\textcolor{keyword}{const}\ Ptype\ \&b1,\textcolor{keyword}{const}\ Ptype\ \&b2)\{}
\DoxyCodeLine{01007\ \ \ Ptype\ db=\ b2\ -\/\ b1;}
\DoxyCodeLine{01008\ \ \ Ptype\ da=\ a2\ -\/\ a1;}
\DoxyCodeLine{01009\ \ \ Ptype\ d1=\ b1\ -\/\ a1;}
\DoxyCodeLine{01010\ \ \ }
\DoxyCodeLine{01011\ \ \ \textcolor{keywordtype}{double}\ tmp\ =\ (db\string^da);}
\DoxyCodeLine{01012\ \ \ \textcolor{keywordflow}{if}(tmp==0)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};\ \textcolor{comment}{//\ parallel\ case}}
\DoxyCodeLine{01013\ \ \ }
\DoxyCodeLine{01014\ \ \ \textcolor{keywordtype}{double}\ B\ =\ (da\string^d1)\ /\ tmp;}
\DoxyCodeLine{01015\ \ \ \textcolor{keywordflow}{if}(\ (B>1)\ ||\ (B<0))\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01016\ \ \ B\ =\ (db\string^d1)\ /\ tmp;}
\DoxyCodeLine{01017\ \ \ \textcolor{keywordflow}{if}(\ (B>1)\ ||\ (B<0))\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
...
\DoxyCodeLine{01023\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespace_utilities_afc7611a51add4102b0f2109c5d652a20}{inCurve}}(\textcolor{keyword}{const}\ Ptype\ \&x,\textcolor{keyword}{const}\ std::vector<Ptype>\ \&H)\{}
\DoxyCodeLine{01024\ \ \ \textcolor{keywordflow}{if}(H.size()\ <\ 3)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01025\ \ \ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ p1,p2;}
\DoxyCodeLine{01026\ \ \ \textcolor{keywordtype}{long}\ w=0;}
\DoxyCodeLine{01027\ \ \ \textcolor{keywordtype}{size\_t}\ n=H.size();}
\DoxyCodeLine{01028\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i=0\ ;\ i<n\ ;\ ++i)\{}
\DoxyCodeLine{01029\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ j\ =\ (i+1)\%n;}
\DoxyCodeLine{01030\ \ \ \ \ \textcolor{keywordflow}{if}(H[j][1]\ !=\ H[i][1])\{\ \textcolor{comment}{//\ ignore\ horizontal\ segments}}
\DoxyCodeLine{01031\ \ \ \ \ \ \ p1[1]\ =\ H[i][1]\ -\/\ x[1];}
\DoxyCodeLine{01032\ \ \ \ \ \ \ p2[1]\ =\ H[j][1]\ -\/\ x[1];}
\DoxyCodeLine{01033\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ p1[1]*p2[1]\ <\ 0\ \ )\{}
\DoxyCodeLine{01034\ \ \ \ \ \ \ \ \ p1[0]\ =\ H[i][0]\ -\/\ x[0];}
\DoxyCodeLine{01035\ \ \ \ \ \ \ \ \ p2[0]\ =\ H[j][0]\ -\/\ x[0];}
\DoxyCodeLine{01036\ }
\DoxyCodeLine{01037\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(p1[0]>=0\ \&\&\ p2[0]>=0)\{}
\DoxyCodeLine{01038\ \ \ \ \ \ \ \ \ \ \ w\ +=\ 2*(\ p1[1]\ >=\ 0\ )\ -\/\ 1;}
\DoxyCodeLine{01039\ \ \ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(p1[0]\ >\ 0\ ||\ p2[0]\ >\ 0)\{}
\DoxyCodeLine{01040\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ s\ =\ p1[0]\ -\/\ (p2[0]-\/p1[0])*p1[1]/(p2[1]-\/p1[1]);}
\DoxyCodeLine{01041\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(s\ >=\ 0)\{}
\DoxyCodeLine{01042\ \ \ \ \ \ \ \ \ \ \ \ \ w\ +=\ 2*(\ p1[1]\ >=\ 0\ )\ -\/\ 1;}
\DoxyCodeLine{01043\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01044\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01045\ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(p2[1]==0)\{\ \ \textcolor{comment}{//\ second\ point\ on\ lines}}
\DoxyCodeLine{01046\ \ \ \ \ \ \ \ \ p2[0]\ =\ H[j][0]\ -\/\ x[0];}
\DoxyCodeLine{01047\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ this\ needs\ to\ be\ handled\ separately\ because\ of\ the\ }}
\DoxyCodeLine{01048\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ possibility\ that\ the\ curve\ touches\ the\ line\ a\ one\ vertex\ }}
\DoxyCodeLine{01049\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ but\ does\ not\ cross\ it.}}
\DoxyCodeLine{01050\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(p2[0]\ >=\ 0)\{}
\DoxyCodeLine{01051\ }
\DoxyCodeLine{01052\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ k\ =\ (j+1)\%n;}
\DoxyCodeLine{01053\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{while}(\ H[k][1]\ -\/\ x[1]\ ==\ 0\ \&\&\ k!=i)\ k\ =\ (k+1)\%n;}
\DoxyCodeLine{01054\ }
\DoxyCodeLine{01055\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(k!=i\ \&\&\ p1[1]*(\ H[k][1]\ -\/\ x[1]\ )\ <=\ 0)\{}
\DoxyCodeLine{01056\ \ \ \ \ \ \ \ \ \ \ \ \ w\ +=\ \ 2*(\ p1[1]\ >=\ 0\ )\ -\/\ 1;}
\DoxyCodeLine{01057\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01058\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01059\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01060\ \ \ \ \ \}}
\DoxyCodeLine{01061\ \ \ \}}
\DoxyCodeLine{01062\ \ \ \textcolor{keywordflow}{return}\ w\ !=\ 0;}
\DoxyCodeLine{01063\ \}}
\DoxyCodeLine{01064\ }
\DoxyCodeLine{01065\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Ptype>}
\DoxyCodeLine{01066\ \textcolor{keywordtype}{bool}\ inhull(PosType\ x[],\textcolor{keyword}{const}\ std::vector<Ptype>\ \&H)\{}
\DoxyCodeLine{01067\ \ \ }
\DoxyCodeLine{01068\ \ \ \textcolor{keywordtype}{size\_t}\ n\ =\ H.size();}
\DoxyCodeLine{01069\ \ \ \textcolor{keywordflow}{if}(n\ <=2)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01070\ \ \ \textcolor{keywordtype}{long}\ w=0;}
\DoxyCodeLine{01071\ \ \ Ptype\ dH,dD;}
\DoxyCodeLine{01072\ \ \ \textcolor{keywordtype}{double}\ B,A;}
\DoxyCodeLine{01073\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i=0\ ;\ i<n-\/1\ ;\ ++i)\{}
\DoxyCodeLine{01074\ \ \ \ \ dH\ =\ H[i+1]-\/H[i];}
\DoxyCodeLine{01075\ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ ==\ 0)\{\ \ \textcolor{comment}{//\ //\ horizontal\ segment}}
\DoxyCodeLine{01076\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(x[1]\ ==\ H[i][1])\{}
\DoxyCodeLine{01077\ \ \ \ \ \ \ \ \ B\ =\ (x[0]-\/H[i][0])/dH[0];}
\DoxyCodeLine{01078\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ B>=0\ \&\&\ B<=1\ )\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \textcolor{comment}{//\ point\ on\ boundary}}
\DoxyCodeLine{01079\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01080\ \ \ \ \ \}\textcolor{keywordflow}{else}\{}
\DoxyCodeLine{01081\ \ \ \ \ \ \ dD[0]\ =\ x[0]-\/H[i][0];}
\DoxyCodeLine{01082\ \ \ \ \ \ \ dD[1]\ =\ x[1]-\/H[i][1];}
\DoxyCodeLine{01083\ \ \ \ \ \ \ A\ =\ dD[1]/dH[1];}
\DoxyCodeLine{01084\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ A\ >\ 1\ ||\ A\ <=\ 0)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{01085\ \ \ \ \ \ \ B\ =\ (dH\string^dD)/dH[1];}
\DoxyCodeLine{01086\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(B==0)\{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ on\ the\ boundary}}
\DoxyCodeLine{01087\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ boundaries\ are\ always\ in}}
\DoxyCodeLine{01088\ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(B>0)\{}
\DoxyCodeLine{01089\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ >\ 0)\ ++w;}
\DoxyCodeLine{01090\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ -\/-\/w;}
\DoxyCodeLine{01091\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01092\ \ \ \ \ \}}
\DoxyCodeLine{01093\ \ \ \}}
\DoxyCodeLine{01094\ \ \ }
\DoxyCodeLine{01095\ \ \ \textcolor{keywordflow}{return}\ abs(w);}
\DoxyCodeLine{01096\ \}}
\DoxyCodeLine{01097\ }
\DoxyCodeLine{01098\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{01099\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ inhull<Point\ *>(PosType\ x[],\textcolor{keyword}{const}\ std::vector<Point\ *>\ \&H)\{}
\DoxyCodeLine{01100\ \ \ }
\DoxyCodeLine{01101\ \ \ \textcolor{keywordtype}{size\_t}\ n\ =\ H.size();}
\DoxyCodeLine{01102\ \ \ \textcolor{keywordflow}{if}(n\ <=2)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01103\ \ \ \textcolor{keywordtype}{long}\ w=0;}
\DoxyCodeLine{01104\ \ \ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ dH,dD;}
\DoxyCodeLine{01105\ \ \ \textcolor{keywordtype}{double}\ B,A;}
\DoxyCodeLine{01106\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i=0\ ;\ i<n-\/1\ ;\ ++i)\{}
\DoxyCodeLine{01107\ \ \ \ \ dH\ =\ *H[i+1]-\/*H[i];}
\DoxyCodeLine{01108\ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ ==\ 0)\{\ \ \textcolor{comment}{//\ //\ horizontal\ segment}}
\DoxyCodeLine{01109\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(x[1]\ ==\ H[i]-\/>x[1])\{}
\DoxyCodeLine{01110\ \ \ \ \ \ \ \ \ B\ =\ (x[0]-\/H[i]-\/>x[0])/dH[0];}
\DoxyCodeLine{01111\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ B>=0\ \&\&\ B<=1\ )\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \textcolor{comment}{//\ point\ on\ boundary}}
\DoxyCodeLine{01112\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01113\ \ \ \ \ \}\textcolor{keywordflow}{else}\{}
\DoxyCodeLine{01114\ \ \ \ \ \ \ dD[0]\ =\ x[0]-\/H[i]-\/>x[0];}
\DoxyCodeLine{01115\ \ \ \ \ \ \ dD[1]\ =\ x[1]-\/H[i]-\/>x[1];}
\DoxyCodeLine{01116\ \ \ \ \ \ \ A\ =\ dD[1]/dH[1];}
\DoxyCodeLine{01117\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ A\ >\ 1\ ||\ A\ <=\ 0)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{01118\ \ \ \ \ \ \ B\ =\ (dH\string^dD)/dH[1];}
\DoxyCodeLine{01119\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(B==0)\{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ on\ the\ boundary}}
\DoxyCodeLine{01120\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ boundaries\ are\ always\ in}}
\DoxyCodeLine{01121\ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(B>0)\{}
\DoxyCodeLine{01122\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ >\ 0)\ ++w;}
\DoxyCodeLine{01123\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ -\/-\/w;}
\DoxyCodeLine{01124\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01125\ \ \ \ \ \}}
\DoxyCodeLine{01126\ \ \ \}}
\DoxyCodeLine{01127\ \ \ }
\DoxyCodeLine{01128\ \ \ \textcolor{keywordflow}{return}\ w;}
\DoxyCodeLine{01129\ \}}
\DoxyCodeLine{01130\ }
\DoxyCodeLine{01132\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{01133\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespace_utilities_a85c8c08716d4ebdceb0b8c31d543773a}{inhull<RAY>}}(PosType\ x[],\textcolor{keyword}{const}\ std::vector<RAY>\ \&H)\{}
\DoxyCodeLine{01134\ \ \ }
\DoxyCodeLine{01135\ \ \ \textcolor{keywordtype}{size\_t}\ n\ =\ H.size();}
\DoxyCodeLine{01136\ \ \ \textcolor{keywordflow}{if}(n\ <=2)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01137\ \ \ \textcolor{keywordtype}{long}\ w=0;}
\DoxyCodeLine{01138\ \ \ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ dH,dD;}
\DoxyCodeLine{01139\ \ \ \textcolor{keywordtype}{double}\ B,A;}
\DoxyCodeLine{01140\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i=0\ ;\ i<n-\/1\ ;\ ++i)\{}
\DoxyCodeLine{01141\ \ \ \ \ dH\ =\ H[i+1].x-\/H[i].x;}
\DoxyCodeLine{01142\ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ ==\ 0)\{\ \ \textcolor{comment}{//\ //\ horizontal\ segment}}
\DoxyCodeLine{01143\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(x[1]\ ==\ H[i].x[1])\{}
\DoxyCodeLine{01144\ \ \ \ \ \ \ \ \ B\ =\ (x[0]-\/H[i].x[0])/dH[0];}
\DoxyCodeLine{01145\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ B>=0\ \&\&\ B<=1\ )\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \textcolor{comment}{//\ point\ on\ boundary}}
\DoxyCodeLine{01146\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01147\ \ \ \ \ \}\textcolor{keywordflow}{else}\{}
\DoxyCodeLine{01148\ \ \ \ \ \ \ dD[0]\ =\ x[0]-\/H[i].x[0];}
\DoxyCodeLine{01149\ \ \ \ \ \ \ dD[1]\ =\ x[1]-\/H[i].x[1];}
\DoxyCodeLine{01150\ \ \ \ \ \ \ A\ =\ dD[1]/dH[1];}
\DoxyCodeLine{01151\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ A\ >\ 1\ ||\ A\ <=\ 0)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{01152\ \ \ \ \ \ \ B\ =\ (dH\string^dD)/dH[1];}
\DoxyCodeLine{01153\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(B==0)\{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ on\ the\ boundary}}
\DoxyCodeLine{01154\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ boundaries\ are\ always\ in}}
\DoxyCodeLine{01155\ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(B>0)\{}
\DoxyCodeLine{01156\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ >\ 0)\ ++w;}
\DoxyCodeLine{01157\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ -\/-\/w;}
\DoxyCodeLine{01158\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01159\ \ \ \ \ \}}
\DoxyCodeLine{01160\ \ \ \}}
\DoxyCodeLine{01161\ \ \ }
\DoxyCodeLine{01162\ \ \ \textcolor{keywordflow}{return}\ w;}
\DoxyCodeLine{01163\ \}}
\DoxyCodeLine{01164\ }
\DoxyCodeLine{01165\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{01166\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ inhull<PosType\ *>(PosType\ x[],\textcolor{keyword}{const}\ std::vector<PosType\ *>\ \&H)\{}
\DoxyCodeLine{01167\ \ \ }
\DoxyCodeLine{01168\ \ \ \textcolor{keywordtype}{size\_t}\ n\ =\ H.size();}
\DoxyCodeLine{01169\ \ \ \textcolor{keywordflow}{if}(n\ <=2)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01170\ \ \ \textcolor{keywordtype}{long}\ w=0;}
\DoxyCodeLine{01171\ \ \ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ dH,dD;}
\DoxyCodeLine{01172\ \ \ \textcolor{keywordtype}{double}\ B,A;}
\DoxyCodeLine{01173\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i=0\ ;\ i<n-\/1\ ;\ ++i)\{}
\DoxyCodeLine{01174\ \ \ \ \ dH[0]\ =\ H[i+1][0]-\/H[i][0];}
\DoxyCodeLine{01175\ \ \ \ \ dH[1]\ =\ H[i+1][1]-\/H[i][1];}
\DoxyCodeLine{01176\ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ ==\ 0)\{\ \ \textcolor{comment}{//\ //\ horizontal\ segment}}
\DoxyCodeLine{01177\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(x[1]\ ==\ H[i][1])\{}
\DoxyCodeLine{01178\ \ \ \ \ \ \ \ \ B\ =\ (x[0]-\/H[i][0])/dH[0];}
\DoxyCodeLine{01179\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ B>=0\ \&\&\ B<=1\ )\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \textcolor{comment}{//\ point\ on\ boundary}}
\DoxyCodeLine{01180\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01181\ \ \ \ \ \}\textcolor{keywordflow}{else}\{}
\DoxyCodeLine{01182\ \ \ \ \ \ \ dD[0]\ =\ x[0]-\/H[i][0];}
\DoxyCodeLine{01183\ \ \ \ \ \ \ dD[1]\ =\ x[1]-\/H[i][1];}
\DoxyCodeLine{01184\ \ \ \ \ \ \ A\ =\ dD[1]/dH[1];}
\DoxyCodeLine{01185\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ A\ >\ 1\ ||\ A\ <=\ 0)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{01186\ \ \ \ \ \ \ B\ =\ (dH\string^dD)/dH[1];}
\DoxyCodeLine{01187\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(B==0)\{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ on\ the\ boundary}}
\DoxyCodeLine{01188\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ boundaries\ are\ always\ in}}
\DoxyCodeLine{01189\ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(B>0)\{}
\DoxyCodeLine{01190\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(dH[1]\ >\ 0)\ ++w;}
\DoxyCodeLine{01191\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ -\/-\/w;}
\DoxyCodeLine{01192\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01193\ \ \ \ \ \}}
\DoxyCodeLine{01194\ \ \ \}}
\DoxyCodeLine{01195\ \ \ }
\DoxyCodeLine{01196\ \ \ \textcolor{keywordflow}{return}\ w;}
\DoxyCodeLine{01197\ \}}
\DoxyCodeLine{01198\ }
\DoxyCodeLine{01199\ }
\DoxyCodeLine{01200\ \textcolor{comment}{/***\ \(\backslash\)brief\ Calculate\ the\ k\ nearest\ neighbors\ concave\ hull.}}
\DoxyCodeLine{01201\ \textcolor{comment}{\ }}
\DoxyCodeLine{01202\ \textcolor{comment}{\ This\ algorithem\ is\ guarenteed\ to\ find\ a\ curve\ that\ serounds\ an\ island\ of\ points,\ but\ not\ all\ islands\ unless\ check==true.}}
\DoxyCodeLine{01203\ \textcolor{comment}{\ }}
\DoxyCodeLine{01204\ \textcolor{comment}{\ If\ it\ at\ first\ fails\ with\ the\ k\ input,\ k\ will\ increase.\ \ The\ final\ k\ relaces\ the\ input\ k.}}
\DoxyCodeLine{01205\ \textcolor{comment}{\ }}
\DoxyCodeLine{01206\ \textcolor{comment}{\ check\ determines\ whether\ a\ final\ check\ is\ done\ to\ determine\ whether\ all\ the\ raminaing\ points\ are\ inside\ the\ hull.\ \ Otherwise\ it\ is\ possible\ to\ get\ multiple\ disconnected\ clusters\ and\ the\ hull\ will\ surround\ only\ one.}}
\DoxyCodeLine{01207\ \textcolor{comment}{\ */}}
\DoxyCodeLine{01208\ }
\DoxyCodeLine{01209\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Ptype>}
\DoxyCodeLine{01210\ std::vector<Ptype>\ \mbox{\hyperlink{namespace_utilities_abe345295eb171c0665350842426124bd}{concaveK}}(std::vector<Ptype>\ \&points,\textcolor{keywordtype}{int}\ \&k,\textcolor{keywordtype}{bool}\ check=\textcolor{keyword}{true})}
\DoxyCodeLine{01211\ \{}
\DoxyCodeLine{01212\ \ \ \textcolor{comment}{//std::cout\ <<\ "{}finding\ hull\ ....\ "{};}}
\DoxyCodeLine{01213\ \ \ \textcolor{keywordflow}{if}(points.size()\ <=\ 3)\{}
\DoxyCodeLine{01214\ \ \ \ \ \textcolor{keywordflow}{return}\ points;}
\DoxyCodeLine{01215\ \ \ \}}
\DoxyCodeLine{01216\ \ \ }
\DoxyCodeLine{01217\ \ \ \textcolor{keywordflow}{if}(k\ \ <\ 3)\ k\ =3;}
\DoxyCodeLine{01218\ \ \ }
\DoxyCodeLine{01219\ \ \ \textcolor{keywordtype}{size\_t}\ npoints\ =\ points.size();}
\DoxyCodeLine{01220\ \ \ }
\DoxyCodeLine{01221\ \ \ \textcolor{comment}{//\ \ \{}}
\DoxyCodeLine{01222\ \ \ \textcolor{comment}{//\ \ \ \ tree.pop(7);}}
\DoxyCodeLine{01223\ \ \ \textcolor{comment}{//\ \ \ \ RandomNumbers\_NR\ ran(123);}}
\DoxyCodeLine{01224\ \ \ \textcolor{comment}{//\ \ \ \ std::vector<double>\ radii;}}
\DoxyCodeLine{01225\ \ \ \textcolor{comment}{//\ \ \ \ std::vector<size\_t>\ neighbors;}}
\DoxyCodeLine{01226\ \ \ \textcolor{comment}{//\ \ \ \ Point\_2d\ point;}}
\DoxyCodeLine{01227\ \ \ \textcolor{comment}{//\ \ \ \ for(int\ i\ =\ 0\ ;\ i<100;\ ++i)\{}}
\DoxyCodeLine{01228\ \ \ \textcolor{comment}{//\ \ \ \ \ \ point[0]\ =\ (1-\/2*ran());}}
\DoxyCodeLine{01229\ \ \ \textcolor{comment}{//\ \ \ \ \ \ point[1]\ =\ (1-\/2*ran());}}
\DoxyCodeLine{01230\ \ \ \textcolor{comment}{//\ \ \ \ \ \ tree.NearestNeighbors(point.x,k,radii,neighbors);}}
\DoxyCodeLine{01231\ \ \ \textcolor{comment}{//\ \ \ \ \}}}
\DoxyCodeLine{01232\ \ \ \textcolor{comment}{//\ \ \ \ for(auto\ p\ :\ points)\{}}
\DoxyCodeLine{01233\ \ \ \textcolor{comment}{//\ \ \ \ \ \ tree.NearestNeighbors(p.x,k,radii,neighbors);}}
\DoxyCodeLine{01234\ \ \ \textcolor{comment}{//\ \ \ \ \}}}
\DoxyCodeLine{01235\ \ \ \textcolor{comment}{//\ \ \}}}
\DoxyCodeLine{01236\ \ \ std::vector<Ptype>\ hull;}
\DoxyCodeLine{01237\ \ \ }
\DoxyCodeLine{01238\ \ \ \textcolor{keywordtype}{double}\ xmin\ =\ points[0][0];}
\DoxyCodeLine{01239\ \ \ \textcolor{keywordtype}{size\_t}\ first\_point\_index\ =\ 0;}
\DoxyCodeLine{01240\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i=0\ ;\ i<npoints\ ;\ ++i)\{}
\DoxyCodeLine{01241\ \ \ \ \ \textcolor{keywordflow}{if}(points[i][0]\ <\ xmin)\{}
\DoxyCodeLine{01242\ \ \ \ \ \ \ xmin\ =\ points[i][0];}
\DoxyCodeLine{01243\ \ \ \ \ \ \ first\_point\_index\ =\ i;}
\DoxyCodeLine{01244\ \ \ \ \ \}}
\DoxyCodeLine{01245\ \ \ \}}
\DoxyCodeLine{01246\ \ \ }
\DoxyCodeLine{01247\ \ \ Ptype\ firstpoint\ =\ points[first\_point\_index];}
\DoxyCodeLine{01248\ \ \ }
\DoxyCodeLine{01249\ \ \ std::vector<size\_t>\ remaining\_index;}
\DoxyCodeLine{01250\ \ \ \textcolor{keywordtype}{bool}\ segmented\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{01251\ \ \ \textcolor{keywordflow}{while}(segmented)\{}
\DoxyCodeLine{01252\ \ \ \ \ \textcolor{keywordtype}{bool}\ found=\textcolor{keyword}{false};}
\DoxyCodeLine{01253\ \ \ \ \ \textcolor{keywordflow}{while}(!found)\{\ \ \textcolor{comment}{//\ if\ hull\ leaves\ points\ out\ repeat\ with\ larger\ k}}
\DoxyCodeLine{01254\ \ \ \ \ \ \ hull.resize(0);}
\DoxyCodeLine{01255\ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_vec}{TreeSimpleVec<Ptype>}}\ tree(points.data(),npoints,2);}
\DoxyCodeLine{01256\ \ \ \ \ \ \ }
\DoxyCodeLine{01257\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(k>=points.size())\{}
\DoxyCodeLine{01258\ \ \ \ \ \ \ \ \ hull\ =\ \mbox{\hyperlink{namespace_utilities_ac0dc30c5f6b7875ed50bcae884432756}{convex\_hull}}(points);}
\DoxyCodeLine{01259\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ hull;}
\DoxyCodeLine{01260\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01261\ \ \ \ \ \ \ }
\DoxyCodeLine{01262\ \ \ \ \ \ \ hull.push\_back(firstpoint);}
\DoxyCodeLine{01263\ \ \ \ \ \ \ \textcolor{comment}{//\ point\ is\ not\ popper\ frum\ the\ free\ so\ that\ it\ can\ be\ found\ at\ the\ end}}
\DoxyCodeLine{01264\ \ \ \ \ \ \ }
\DoxyCodeLine{01265\ \ \ \ \ \ \ std::vector<double>\ radii;}
\DoxyCodeLine{01266\ \ \ \ \ \ \ std::vector<size\_t>\ neighbors;}
\DoxyCodeLine{01267\ \ \ \ \ \ \ Ptype\ hull\_end\ =\ hull.back();}
\DoxyCodeLine{01268\ \ \ \ \ \ \ }
\DoxyCodeLine{01269\ \ \ \ \ \ \ Ptype\ v1;}
\DoxyCodeLine{01270\ \ \ \ \ \ \ Ptype\ last\_point\ =\ Ptype(hull[0][0],hull[0][1]-\/1);}
\DoxyCodeLine{01271\ \ \ \ \ \ \ Ptype\ v2;}
\DoxyCodeLine{01272\ \ \ \ \ \ \ }
\DoxyCodeLine{01273\ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ new\_index;}
\DoxyCodeLine{01274\ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ theta\_max=0;}
\DoxyCodeLine{01275\ \ \ \ \ \ \ Ptype\ new\_point;}
\DoxyCodeLine{01276\ \ \ \ \ \ \ std::vector<double>\ thetas;}
\DoxyCodeLine{01277\ \ \ \ \ \ \ std::vector<int>\ sorted\_index(k);}
\DoxyCodeLine{01278\ \ \ \ \ \ \ }
\DoxyCodeLine{01279\ \ \ \ \ \ \ \textcolor{keywordflow}{while}((hull[0]\ !=\ hull.back()\ \&\&\ found)\ ||\ hull.size()==1\ )\{}
\DoxyCodeLine{01280\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01281\ \ \ \ \ \ \ \ \ tree.\mbox{\hyperlink{class_tree_simple_vec_a656687586737eedb85a0686005fc29a0}{NearestNeighbors}}(hull\_end.x,k,radii,neighbors);}
\DoxyCodeLine{01282\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01283\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{long}\ Nneighbors\ =\ neighbors.size();\ \textcolor{comment}{//\ incase\ there\ are\ not\ k\ left}}
\DoxyCodeLine{01284\ \ \ \ \ \ \ \ \ thetas.resize(Nneighbors);}
\DoxyCodeLine{01285\ \ \ \ \ \ \ \ \ sorted\_index.resize(Nneighbors);}
\DoxyCodeLine{01286\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01287\ \ \ \ \ \ \ \ \ v1\ =\ hull\_end\ -\/\ last\_point;}
\DoxyCodeLine{01288\ \ \ \ \ \ \ \ \ theta\_max\ =\ 0;}
\DoxyCodeLine{01289\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i=0;\ i<Nneighbors\ ;\ ++i)\{}
\DoxyCodeLine{01290\ \ \ \ \ \ \ \ \ \ \ v2\ =\ points[neighbors[i]]\ -\/\ hull\_end;}
\DoxyCodeLine{01291\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ cross\ =\ v1\string^v2,dot\ =\ (v1*v2);}
\DoxyCodeLine{01292\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(cross\ ==\ 0\ \&\&\ dot\ <=\ 0)\ thetas[i]\ =\ -\/PI;\ \ \textcolor{comment}{//\ prevents\ backtracking\ at\ beginning}}
\DoxyCodeLine{01293\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ thetas[i]\ =\ atan2(\ cross\ ,\ dot\ );}
\DoxyCodeLine{01294\ \ \ \ \ \ \ \ \ \ \ sorted\_index[i]\ =\ i;}
\DoxyCodeLine{01295\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01296\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01297\ \ \ \ \ \ \ \ \ std::sort(sorted\_index.begin(),sorted\_index.end()}
\DoxyCodeLine{01298\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,[\&thetas](\textcolor{keywordtype}{int}\ i,\textcolor{keywordtype}{int}\ j)\{return\ thetas[i]\ >\ thetas[j];\}\ );}
\DoxyCodeLine{01299\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01300\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ trial=0;}
\DoxyCodeLine{01301\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{bool}\ intersect\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{01302\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{while}(intersect\ \&\&\ trial\ <\ Nneighbors)\{}
\DoxyCodeLine{01303\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01304\ \ \ \ \ \ \ \ \ \ \ new\_index\ =\ neighbors[\ sorted\_index[trial]\ ];}
\DoxyCodeLine{01305\ \ \ \ \ \ \ \ \ \ \ new\_point\ =\ points[\ new\_index\ ];}
\DoxyCodeLine{01306\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01307\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(hull.size()\ <=\ 3)\ intersect\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{01308\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01309\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ check\ that\ new\ edge\ doesn't\ cross\ earlier\ edge}}
\DoxyCodeLine{01310\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{long}\ i\ =\ hull.size()\ -\/\ 2\ ;\ i\ >\ 1\ ;\ -\/-\/i)\{}
\DoxyCodeLine{01311\ \ \ \ \ \ \ \ \ \ \ \ \ intersect\ =\ segments\_cross(hull[i],hull[i-\/1]}
\DoxyCodeLine{01312\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,hull.back(),new\_point);}
\DoxyCodeLine{01313\ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01314\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(intersect)\{}
\DoxyCodeLine{01315\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{01316\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01317\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01318\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01319\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(new\_index\ ==\ first\_point\_index\ \&\&\ !intersect)\{}
\DoxyCodeLine{01320\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ check\ that\ neighbors\ are\ inside\ hull\ that\ would\ be\ closed}}
\DoxyCodeLine{01321\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ this\ is\ to\ prevent\ pre-\/mature\ closing\ of\ the\ loop}}
\DoxyCodeLine{01322\ \ \ \ \ \ \ \ \ \ \ \ \ hull.push\_back(new\_point);}
\DoxyCodeLine{01323\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t}\ i\ :\ neighbors)\{}
\DoxyCodeLine{01324\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(i\ !=\ new\_index\ \&\&\ !\mbox{\hyperlink{namespace_utilities_afc7611a51add4102b0f2109c5d652a20}{inCurve}}(points[i],hull))\{}
\DoxyCodeLine{01325\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ intersect\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{01326\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{01327\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01328\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01329\ \ \ \ \ \ \ \ \ \ \ \ \ hull.pop\_back();\ \ }
\DoxyCodeLine{01330\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01331\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01332\ \ \ \ \ \ \ \ \ \ \ ++trial;}
\DoxyCodeLine{01333\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01334\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01335\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(intersect)\{}
\DoxyCodeLine{01336\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ std::cout\ <<\ "{}Intersection\ ..."{}\ <<\ k\ <<\ std::endl;}}
\DoxyCodeLine{01337\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01338\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ std::ofstream\ logfile("{}testpoint.csv"{});}}
\DoxyCodeLine{01339\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ for(auto\ \&p\ :\ points)\{}}
\DoxyCodeLine{01340\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ logfile\ <<\ p[0]\ <<"{},"{}<<\ p[1]\ <<\ std::endl;}}
\DoxyCodeLine{01341\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \}}}
\DoxyCodeLine{01342\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile.close();}}
\DoxyCodeLine{01343\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01344\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile.open("{}testhull.csv"{});}}
\DoxyCodeLine{01345\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ for(auto\ \&p\ :\ hull)\{}}
\DoxyCodeLine{01346\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ logfile\ <<\ p[0]\ <<"{},"{}<<\ p[1]\ <<\ std::endl;}}
\DoxyCodeLine{01347\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \}}}
\DoxyCodeLine{01348\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile\ <<\ new\_point[0]\ <<"{},"{}<<\ new\_point[1]\ <<\ std::endl;}}
\DoxyCodeLine{01349\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile.close();}}
\DoxyCodeLine{01350\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01351\ \ \ \ \ \ \ \ \ \ \ k\ *=\ 2;}
\DoxyCodeLine{01352\ \ \ \ \ \ \ \ \ \ \ found\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{01353\ \ \ \ \ \ \ \ \ \}\textcolor{keywordflow}{else}\{}
\DoxyCodeLine{01354\ \ \ \ \ \ \ \ \ \ \ hull.push\_back(new\_point);}
\DoxyCodeLine{01355\ \ \ \ \ \ \ \ \ \ \ last\_point\ =\ hull\_end;}
\DoxyCodeLine{01356\ \ \ \ \ \ \ \ \ \ \ hull\_end\ =\ hull.back();}
\DoxyCodeLine{01357\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//tree.print();}}
\DoxyCodeLine{01358\ \ \ \ \ \ \ \ \ \ \ tree.\mbox{\hyperlink{class_tree_simple_vec_a4ebbaa4a5dffb04458d1cf71f241575a}{pop}}(new\_index);}
\DoxyCodeLine{01359\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//tree.print();}}
\DoxyCodeLine{01360\ \ \ \ \ \ \ \ \ \ \ found\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{01361\ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{01362\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \{}}
\DoxyCodeLine{01363\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ Ptype\ center;}}
\DoxyCodeLine{01364\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ PixelMap\ map(center.x,\ 512,\ 3.\ /\ 512.);}}
\DoxyCodeLine{01365\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01366\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ map.drawCurve(hull,1);}}
\DoxyCodeLine{01367\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ map.drawPoints(points,0,2);}}
\DoxyCodeLine{01368\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ map.printFITS("{}!concavek\_test"{}+\ std::to\_string(f)\ +"{}.fits"{});}}
\DoxyCodeLine{01369\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ std::cout\ <<\ "{}Test\ plot\ :\ concavek\_test"{}\ <<\ f++\ <<\ "{}.fits"{}\ <<\ std::endl;}}
\DoxyCodeLine{01370\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \}}}
\DoxyCodeLine{01371\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{01372\ \ \ \ \ \ \ \}}
\DoxyCodeLine{01373\ \ \ \ \ \ \ remaining\_index\ =\ tree.\mbox{\hyperlink{class_tree_simple_vec_a56b9e9e607df32ada57c3a666d7a6470}{get\_index}}();}
\DoxyCodeLine{01374\ \ \ \ \ \}}
\DoxyCodeLine{01375\ \ \ \ \ \textcolor{comment}{//\ test\ if\ all\ remaining\ points\ are\ in\ the\ hull}}
\DoxyCodeLine{01376\ \ \ \ \ }
\DoxyCodeLine{01377\ \ \ \ \ }
\DoxyCodeLine{01378\ \ \ \ \ segmented\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{01379\ \ \ \ \ \textcolor{keywordflow}{if}(check)\{}
\DoxyCodeLine{01380\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}\ i\ :\ remaining\_index)\{}
\DoxyCodeLine{01381\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(!\mbox{\hyperlink{namespace_utilities_afc7611a51add4102b0f2109c5d652a20}{inCurve}}(points[i],hull))\{}
\DoxyCodeLine{01382\ \ \ \ \ \ \ \ \ \ \ segmented\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{01383\ \ \ \ \ \ \ \ \ \ \ k\ *=\ 2;}
\DoxyCodeLine{01384\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ std::cout\ <<\ "{}point\ outside\ ...\ "{};}}
\DoxyCodeLine{01385\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ std::ofstream\ logfile("{}testpoint.csv"{});}}
\DoxyCodeLine{01386\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ for(auto\ \&p\ :\ points)\{}}
\DoxyCodeLine{01387\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ logfile\ <<\ p[0]\ <<"{},"{}<<\ p[1]\ <<\ std::endl;}}
\DoxyCodeLine{01388\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \}}}
\DoxyCodeLine{01389\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile.close();}}
\DoxyCodeLine{01390\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01391\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile.open("{}testhull.csv"{});}}
\DoxyCodeLine{01392\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ for(auto\ \&p\ :\ hull)\{}}
\DoxyCodeLine{01393\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ logfile\ <<\ p[0]\ <<"{},"{}<<\ p[1]\ <<\ std::endl;}}
\DoxyCodeLine{01394\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \}}}
\DoxyCodeLine{01395\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ logfile.close();}}
...
\DoxyCodeLine{01402\ \ \ \}}
\DoxyCodeLine{01403\ \ \ }
\DoxyCodeLine{01404\ \ \ \textcolor{comment}{//std::cout\ <<\ "{}found\ hull"{}\ <<\ std::endl;}}
\DoxyCodeLine{01405\ \ \ \textcolor{comment}{//hull.pop\_back();}}
\DoxyCodeLine{01406\ \ \ }
\DoxyCodeLine{01407\ \ \ \textcolor{keywordflow}{return}\ hull;}
\DoxyCodeLine{01408\ \}}
\DoxyCodeLine{01409\ }
\DoxyCodeLine{01410\ }
\DoxyCodeLine{01411\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Ptype>}
\DoxyCodeLine{01412\ \textcolor{keywordtype}{void}\ testconcaveK()\{}
\DoxyCodeLine{01413\ \ \ std::vector<Ptype>\ points(200);}
\DoxyCodeLine{01414\ \ \ RandomNumbers\_NR\ ran(2312);}
\DoxyCodeLine{01415\ \ \ }
\DoxyCodeLine{01416\ \ \ \textcolor{keywordflow}{for}(Ptype\ \&p\ :\ points)\{}
\DoxyCodeLine{01417\ \ \ \ \ p[0]\ =\ (1-\/ran());}
\DoxyCodeLine{01418\ \ \ \ \ p[1]\ =\ (1-\/2*ran());}
\DoxyCodeLine{01419\ \ \ \}}
\DoxyCodeLine{01420\ \ \ }
\DoxyCodeLine{01421\ \ \ \textcolor{keywordtype}{double}\ x=-\/1;}
\DoxyCodeLine{01422\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i=0\ ;\ i<\ points.size()/4\ ;\ ++i)\{}
\DoxyCodeLine{01423\ \ \ \ \ points[i][0]\ =\ 1;}
\DoxyCodeLine{01424\ \ \ \ \ points[i][1]\ =\ x;}
\DoxyCodeLine{01425\ \ \ \ \ x\ +=\ 1/25.;}
\DoxyCodeLine{01426\ \ \ \}}
\DoxyCodeLine{01427\ \ \ x=-\/1;}
\DoxyCodeLine{01428\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i=points.size()/4\ ;\ i<\ 2*points.size()/4\ ;\ ++i)\{}
\DoxyCodeLine{01429\ \ \ \ \ points[i][0]\ =\ -\/1;}
\DoxyCodeLine{01430\ \ \ \ \ points[i][1]\ =\ x;}
\DoxyCodeLine{01431\ \ \ \ \ x\ +=\ 1/25.;}
\DoxyCodeLine{01432\ \ \ \}}
\DoxyCodeLine{01433\ \ \ x=-\/1;}
\DoxyCodeLine{01434\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i=2*points.size()/4\ ;\ i<\ 3*points.size()/4\ ;\ ++i)\{}
\DoxyCodeLine{01435\ \ \ \ \ points[i][0]\ =\ x;}
\DoxyCodeLine{01436\ \ \ \ \ points[i][1]\ =\ 1;}
\DoxyCodeLine{01437\ \ \ \ \ x\ +=\ 1/25.;}
\DoxyCodeLine{01438\ \ \ \}}
\DoxyCodeLine{01439\ \ \ x=-\/1;}
\DoxyCodeLine{01440\ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ i=3*points.size()/4\ ;\ i<\ points.size()\ ;\ ++i)\{}
\DoxyCodeLine{01441\ \ \ \ \ points[i][0]\ =\ x;}
\DoxyCodeLine{01442\ \ \ \ \ points[i][1]\ =\ -\/1;}
\DoxyCodeLine{01443\ \ \ \ \ x\ +=\ 1/25.;}
\DoxyCodeLine{01444\ \ \ \}}
\DoxyCodeLine{01445\ \ \ }
\DoxyCodeLine{01446\ \ \ \textcolor{comment}{//\ \ for(int\ i=0\ ;\ i<\ points.size()/2\ ;\ ++i)\{}}
\DoxyCodeLine{01447\ \ \ \textcolor{comment}{//\ \ \ \ points[i][0]\ =\ (1-\/ran())\ -\/\ 2;}}
\DoxyCodeLine{01448\ \ \ \textcolor{comment}{//\ \ \ \ points[i][1]\ =\ (1-\/2*ran());}}
\DoxyCodeLine{01449\ \ \ \textcolor{comment}{//\ \ \}}}
\DoxyCodeLine{01450\ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01451\ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01452\ \ \ \textcolor{comment}{//\ \ points[0][0]\ =\ 0;\ points[0][1]\ =\ -\/1;}}
\DoxyCodeLine{01453\ \ \ \textcolor{comment}{//\ \ points[1][0]\ =\ -\/1;\ points[1][1]\ =\ 0;}}
\DoxyCodeLine{01454\ \ \ \textcolor{comment}{//\ \ points[2][0]\ =\ 0;\ points[2][1]\ =\ 1;}}
\DoxyCodeLine{01455\ \ \ \textcolor{comment}{//\ \ points[3][0]\ =\ 1;\ points[3][1]\ =\ 0;}}
\DoxyCodeLine{01456\ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01457\ \ \ \textcolor{comment}{//\ \ points[4][0]\ =\ -\/1;\ points[4][1]\ =\ 1;}}
\DoxyCodeLine{01458\ \ \ \textcolor{comment}{//\ \ points[5][0]\ =\ 1;\ points[5][1]\ =\ 1;}}
\DoxyCodeLine{01459\ \ \ }
\DoxyCodeLine{01460\ \ \ \textcolor{keywordtype}{int}\ k\ =\ 5;}
\DoxyCodeLine{01461\ \ \ std::vector<Ptype>\ hull\ =\ \mbox{\hyperlink{namespace_utilities_abe345295eb171c0665350842426124bd}{concaveK}}(points,k);}
\DoxyCodeLine{01462\ \ \ Ptype\ center;}
\DoxyCodeLine{01463\ \ \ \mbox{\hyperlink{class_pixel_map}{PixelMap<float>}}\ map(center.x,\ 512,\ 3.\ /\ 512.);}
\DoxyCodeLine{01464\ \ \ }
\DoxyCodeLine{01465\ \ \ map.drawCurve(hull,1);}
\DoxyCodeLine{01466\ \ \ map.drawPoints(points,0,2);}
\DoxyCodeLine{01467\ \ \ map.printFITS(\textcolor{stringliteral}{"{}!concavek\_test.fits"{}});}
\DoxyCodeLine{01468\ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}Test\ plot\ :\ concavek\_test.fits"{}}\ <<\ std::endl;}
\DoxyCodeLine{01469\ \}}
\DoxyCodeLine{01470\ }
\DoxyCodeLine{01472\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \mbox{\hyperlink{namespace_utilities_af55b9c3d5f503bd2c5544cdec2d5aa42}{line\_intersection}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \&v1,\textcolor{keyword}{const}\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \&v2,}
\DoxyCodeLine{01473\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \&w1,\textcolor{keyword}{const}\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \&w2);}
\DoxyCodeLine{01474\ }
\DoxyCodeLine{01475\ }
\DoxyCodeLine{01477\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespace_utilities_afc0243f1746707bddd91dd1295795f9e}{circleIntersetsCurve}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \&x,\textcolor{keywordtype}{double}\ r,\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&v);}
\DoxyCodeLine{01478\ }
\DoxyCodeLine{01481\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespace_utilities_aed8667e8dfb7a5c44ae73262f63dd2ba}{circleOverlapsCurve}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{struct_point__2d}{Point\_2d}}\ \&x,\textcolor{keywordtype}{double}\ r,\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&v);}
\DoxyCodeLine{01482\ }
\DoxyCodeLine{01491\ std::vector<Point\_2d>\ \mbox{\hyperlink{namespace_utilities_a6b3b3327085b03c3dcbb1afadd59fcd4}{envelope}}(\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&v}
\DoxyCodeLine{01492\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&w);}
\DoxyCodeLine{01493\ }
\DoxyCodeLine{01499\ std::vector<Point\_2d>\ \mbox{\hyperlink{namespace_utilities_a8baf3c89ecca31f0771e2d781a856f20}{envelope2}}(\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&v}
\DoxyCodeLine{01500\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&w);}
\DoxyCodeLine{01501\ }
\DoxyCodeLine{01509\ std::vector<std::vector<Point\_2d>\ >\ \mbox{\hyperlink{namespace_utilities_a8de229537fd082d389db103bd918160a}{thicken\_poly}}(}
\DoxyCodeLine{01510\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&v}
\DoxyCodeLine{01511\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,\textcolor{keywordtype}{double}\ R);}
\DoxyCodeLine{01512\ }
\DoxyCodeLine{01513\ \}}
\DoxyCodeLine{01514\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ concave\_hull\_h\ */}\textcolor{preprocessor}{}}
