...
\begin{DoxyCompactList}\small\item\em get the image point for a index number \end{DoxyCompactList}\item 
\Hypertarget{struct_grid_map_a4e6fb0bad8b39a148a8de6b482c7f779}\label{struct_grid_map_a4e6fb0bad8b39a148a8de6b482c7f779} 
\mbox{\hyperlink{struct_r_a_y}{RAY}} {\bfseries ray} (size\+\_\+t index)
\begin{DoxyCompactList}\small\item\em get the image point for a index number \end{DoxyCompactList}\item 
...
{\footnotesize template$<$typename T$>$ }\\\mbox{\hyperlink{class_pixel_map}{Pixel\+Map}}$<$ T $>$ \mbox{\hyperlink{struct_grid_map_a02e65a76db29fd6c074ec237fc547f0d}{get\+Pixel\+Map\+Flux}} () const
...
\item 
\Hypertarget{struct_grid_map_a399748b639e0e3f97bf9946cf4e47f5a}\label{struct_grid_map_a399748b639e0e3f97bf9946cf4e47f5a} 
bool {\bfseries touch} (const Rectangle \&tr1, const Rectangle \&tr2) const
\item 
\Hypertarget{struct_grid_map_ad54e6de7e61100c4579df2a500e61760}\label{struct_grid_map_ad54e6de7e61100c4579df2a500e61760} 
std\+::vector$<$ Rectangle $>$ {\bfseries merge\+\_\+boxes} (std\+::list$<$ Triangle $>$ \&triangles) const
\item 
\Hypertarget{struct_grid_map_abc8d045e43d6d22f606bd48a5c78069f}\label{struct_grid_map_abc8d045e43d6d22f606bd48a5c78069f} 
std\+::vector$<$ Rectangle $>$ {\bfseries merge\+\_\+boxes} (std\+::vector$<$ Triangle $>$ \&triangles) const
\item 
std\+::list$<$ \mbox{\hyperlink{struct_r_a_y}{RAY}} $>$ \mbox{\hyperlink{struct_grid_map_a12dc2253337b4b9199b6f87e5cfb91b8}{find\+\_\+images}} (std\+::vector$<$ \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} $>$ \&ys, std\+::vector$<$ int $>$ \&multiplicity) const
\begin{DoxyCompactList}\small\item\em Returns a list of RAYs from a set of source positions. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Find all images by triangle method. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Find image-\/plane contours of magnification. ~\newline
 This is usually only used within \doxylink{namespace_image_finding}{Image\+Finding}\+:\+: functions where it will also find the contours on the source plane. \end{DoxyCompactList}\item 
\Hypertarget{struct_grid_map_a34b34acb516578ce2282d7a63202d89f}\label{struct_grid_map_a34b34acb516578ce2282d7a63202d89f} 
int {\bfseries get\+Nx} ()
\item 
\Hypertarget{struct_grid_map_a7d8eb40753a5b96a7f895bbd2d8968b5}\label{struct_grid_map_a7d8eb40753a5b96a7f895bbd2d8968b5} 
int {\bfseries get\+Ny} ()
...
This uses \doxylink{struct_grid_map_a12dc2253337b4b9199b6f87e5cfb91b8}{Grid\+Map\+::find\+\_\+images} to find the images. It then finds the point that is closest to the source position. The flux is added to one point per image. The total flux added is returned. No further refinement of the grid is done so it is limited by the resolution of the \doxylink{struct_grid_map}{Grid\+Map}. Some spurious low magnification images can be found. \Hypertarget{struct_grid_map_a0b2753d3584fbe60a632fb157f04bf46}\index{GridMap@{GridMap}!AddSurfaceBrightnesses@{AddSurfaceBrightnesses}}
...
No new rays are shot so the accuracy is limited to the resolution of the \doxylink{struct_grid_map}{Grid\+Map}.

See also \doxylink{class_lens_ac4a8cd1c9c69e16aa7f01a8b0eaff596}{Lens\+::find\+\_\+images()} 
\begin{DoxyParams}{Parameters}
...
\hline
\end{DoxyParams}
\Hypertarget{struct_grid_map_a12dc2253337b4b9199b6f87e5cfb91b8}\index{GridMap@{GridMap}!find\_images@{find\_images}}
\index{find\_images@{find\_images}!GridMap@{GridMap}}
\doxysubsubsection{\texorpdfstring{find\_images()}{find\_images()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{struct_grid_map_a12dc2253337b4b9199b6f87e5cfb91b8} 
std\+::list$<$ \mbox{\hyperlink{struct_r_a_y}{RAY}} $>$ Grid\+Map\+::find\+\_\+images (\begin{DoxyParamCaption}\item[{std\+::vector$<$ \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} $>$ \&}]{ys}{, }\item[{std\+::vector$<$ int $>$ \&}]{multiplicity}{}\end{DoxyParamCaption}) const}



Returns a list of RAYs from a set of source positions. 

The image positions are found in parallel by the triangle method. The order of the output rays will be the same as the sources with multiple images consecutive. The number of images for each source position is given by the {\ttfamily multiplicity} array.

No new rays are shot. The image positions and magnification matrix are interpolated from the nearest image points already in the \doxylink{struct_grid_map}{Grid\+Map}.

See also \doxylink{class_lens_ac4a8cd1c9c69e16aa7f01a8b0eaff596}{Lens\+::find\+\_\+images()} \Hypertarget{struct_grid_map_a02e65a76db29fd6c074ec237fc547f0d}\index{GridMap@{GridMap}!getPixelMapFlux@{getPixelMapFlux}}
...
{\footnotesize\ttfamily \label{struct_grid_map_a02e65a76db29fd6c074ec237fc547f0d} 
template$<$typename T$>$ \\
\mbox{\hyperlink{class_pixel_map}{Pixel\+Map}}$<$ T $>$ Grid\+Map\+::get\+Pixel\+Map\+Flux (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const}
...
update a \doxylink{class_pixel_map}{Pixel\+Map} with the flux in pixels. The map must have precisely the right size and center to match or an exception will be thrown. Constructing the map with \doxylink{class_pixel_map}{Pixel\+Map} get\+Pixel\+Map\+Flux(i) will insure that it does. \Hypertarget{struct_grid_map_aa215b04101b745c282b570ebec20481e}\index{GridMap@{GridMap}!magnificationFlux@{magnificationFlux}}
