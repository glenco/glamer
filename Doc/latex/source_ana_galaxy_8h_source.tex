...
\DoxyCodeLine{00015\ }
\DoxyCodeLine{00032\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_source_multi_ana_galaxy_a5f391bced254f5ed4a36a8cdc1c9474a}{SourceMultiAnaGalaxy}}:\ \textcolor{keyword}{public}\ \mbox{\hyperlink{class_source_aca1ca0b2c7b26cc4fa287ce6ed51cfd8}{Source}}\{}
...
\DoxyCodeLine{00038\ \ \mbox{\hyperlink{class_source_multi_ana_galaxy_a5f391bced254f5ed4a36a8cdc1c9474a}{\string~SourceMultiAnaGalaxy}}();}
\DoxyCodeLine{00039\ \ }
...
\DoxyCodeLine{00075\ \ \}}
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00077\ \ SourceOverzierPlus\&\ CurrentGalaxy()\{}
...
\DoxyCodeLine{00101\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_source_multi_ana_galaxy_a35f23a787c77d92fdbd45f3fef1ee520}{setTheta}}(\textcolor{keyword}{const}\ Point\_2d\ \&p)\{galaxies[index].setTheta(p);\}}
\DoxyCodeLine{00102\ }
\DoxyCodeLine{00103\ \ std::size\_t\ getNumberOfGalaxies()\textcolor{keyword}{\ const\ }\{\textcolor{keywordflow}{return}\ galaxies.size();\}}
\DoxyCodeLine{00104\ }
\DoxyCodeLine{00105\ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_source_multi_ana_galaxy_a73cba06a8e4c42c40e69050ad74d955b}{multiplier}}(PosType\ z,PosType\ mag\_cut,\textcolor{keywordtype}{int}\ Multiplicity,Utilities::RandomNumbers\_NR\ \&ran);}
...
\DoxyCodeLine{00117\ \ \ \ \ searchtree-\/>NearestNeighbor(theta,*radius,index);}
...
\DoxyCodeLine{00125\ \ \ \ \ searchtree-\/>NearestNeighbors(theta,radius.size(),radius,indexes);}
...
\DoxyCodeLine{00132\ \ \ \ \ searchtree-\/>PointsWithinCircle(theta,radius,indexes);}
...
\DoxyCodeLine{00139\ \ \ \ \ searchtree-\/>PointsWithinCircle(theta,radius,indexes);}
\DoxyCodeLine{00140\ \ \ \ \ }
...
\DoxyCodeLine{00165\ \ \ TreeSimpleVec<SourceOverzierPlus>\ *searchtree;}
\DoxyCodeLine{00166\ \ std::string\ input\_gal\_file;}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00168\ \ \textcolor{keywordtype}{void}\ readDataFileMillenn(std::map<Band,double>\ zeropoints,Utilities::RandomNumbers\_NR\ \&ran);}
\DoxyCodeLine{00169\ \ \textcolor{keywordtype}{void}\ assignParams(InputParams\&\ params);}
\DoxyCodeLine{00170\ }
...
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00184\ \textcolor{keyword}{class\ }SourceMultiShapelets:\ \textcolor{keyword}{public}\ \mbox{\hyperlink{class_source_aca1ca0b2c7b26cc4fa287ce6ed51cfd8}{Source}}\{}
\DoxyCodeLine{00185\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00186\ \ \ }
\DoxyCodeLine{00187\ \ \ \textcolor{comment}{//SourceMultiShapelets(InputParams\&\ params);}}
\DoxyCodeLine{00188\ \ \ }
\DoxyCodeLine{00189\ \ \ SourceMultiShapelets(\textcolor{keywordtype}{double}\ mag\_zero\_point):\mbox{\hyperlink{class_source_aca1ca0b2c7b26cc4fa287ce6ed51cfd8}{Source}}(0,\mbox{\hyperlink{struct_point__2d}{Point\_2d}}(0,0),0,-\/1,mag\_zero\_point)\{\};}
\DoxyCodeLine{00190\ \ \ }
\DoxyCodeLine{00192\ \ \ SourceMultiShapelets(\textcolor{keyword}{const}\ std::string\ \&my\_shapelets\_folder\ \ }
...
\DoxyCodeLine{00210\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ );}
\DoxyCodeLine{00211\ }
\DoxyCodeLine{00212\ \ \ \string~SourceMultiShapelets();}
...
\DoxyCodeLine{00235\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_source_multi_shapelets_a4046c8da25755b0184651b56b568272e}{setTheta}}(\textcolor{keyword}{const}\ Point\_2d\ \&p)\{galaxies[index].setTheta(p);\}}
\DoxyCodeLine{00236\ }
...
\DoxyCodeLine{00263\ \ \ \}}
\DoxyCodeLine{00264\ }
\DoxyCodeLine{00265\ \ \textcolor{keyword}{const}\ SourceShapelets\&\ \mbox{\hyperlink{class_source_multi_shapelets_a1acc037d4447662efab600902d146ecd}{operator[]\ }}(std::size\_t\ i)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00269\ \ \}}
\DoxyCodeLine{00270\ \ \ \ \ }
\DoxyCodeLine{00271\ \ SourceShapelets\&\ CurrentGalaxy()\{}
...
\DoxyCodeLine{00295\ \ \textcolor{keywordtype}{void}\ assignParams(InputParams\&\ params);}
