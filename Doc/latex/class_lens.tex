...
\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \mbox{\hyperlink{class_lens_a6d6d04ad98ee9831d8b2e278be6f3a6b}{find\+\_\+image}} (\mbox{\hyperlink{struct_point}{Point}} \&p, double zs, Pos\+Type ytol2, Pos\+Type \&dy2, bool use\+\_\+image\+\_\+guess)
\begin{DoxyCompactList}\small\item\em Find the image position of a source without grid refinement. \end{DoxyCompactList}\item 
\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \mbox{\hyperlink{class_lens_a5688505e56faca56c0f8d424cb5bdd3d}{find\+\_\+image}} (\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \&p, Pos\+Type ytol2, Pos\+Type \&dy2, bool use\+\_\+image\+\_\+guess)
\begin{DoxyCompactList}\small\item\em this version uses the redshift stored in the ray \end{DoxyCompactList}\item 
\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \mbox{\hyperlink{class_lens_a450a498938a92acf5b73568e64f0acfe}{find\+\_\+image}} (\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \&p, Pos\+Type ytol2, Pos\+Type \&dy2, std\+::vector$<$ \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} $>$ \&boundary)
...
\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \mbox{\hyperlink{class_lens_a31dd5ed6c77cca4e00c5ebb8414b18ff}{find\+\_\+image}} (\mbox{\hyperlink{struct_point}{Point}} \&p, double zs, Pos\+Type ytol2, Pos\+Type \&dy2, std\+::vector$<$ \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} $>$ \&boundary)
\item 
\mbox{\Hypertarget{class_lens_ac02a64bb6d6d00858ff83b2803bdafc2}\label{class_lens_ac02a64bb6d6d00858ff83b2803bdafc2}} 
void {\bfseries find\+\_\+point\+\_\+source\+\_\+images} (\mbox{\hyperlink{struct_grid}{Grid}} \&grid, \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} y\+\_\+source, Pos\+Type r\+\_\+source, Pos\+Type z\+\_\+source, std\+::vector$<$ \mbox{\hyperlink{struct_r_a_y}{R\+AY}} $>$ \&images, double dytol2, double dxtol, bool verbose=false)
\item 
...
\mbox{\Hypertarget{class_lens_a6d6d04ad98ee9831d8b2e278be6f3a6b}\label{class_lens_a6d6d04ad98ee9831d8b2e278be6f3a6b}} 
\index{Lens@{Lens}!find\_image@{find\_image}}
\index{find\_image@{find\_image}!Lens@{Lens}}
\doxysubsubsection{\texorpdfstring{find\_image()}{find\_image()}\hspace{0.1cm}{\footnotesize\ttfamily [1/4]}}
{\footnotesize\ttfamily \mbox{\hyperlink{struct_r_a_y}{R\+AY}} Lens\+::find\+\_\+image (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_point}{Point}} \&}]{p,  }\item[{double}]{zs,  }\item[{Pos\+Type}]{ytol2,  }\item[{Pos\+Type \&}]{dy2,  }\item[{bool}]{use\+\_\+image\+\_\+guess }\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{class_lens_a31dd5ed6c77cca4e00c5ebb8414b18ff}\label{class_lens_a31dd5ed6c77cca4e00c5ebb8414b18ff}} 
\index{Lens@{Lens}!find\_image@{find\_image}}
\index{find\_image@{find\_image}!Lens@{Lens}}
\doxysubsubsection{\texorpdfstring{find\_image()}{find\_image()}\hspace{0.1cm}{\footnotesize\ttfamily [2/4]}}
{\footnotesize\ttfamily \mbox{\hyperlink{struct_r_a_y}{R\+AY}} Lens\+::find\+\_\+image (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_point}{Point}} \&}]{p,  }\item[{double}]{zs,  }\item[{Pos\+Type}]{ytol2,  }\item[{Pos\+Type \&}]{dy2,  }\item[{std\+::vector$<$ \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} $>$ \&}]{boundary }\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{class_lens_a5688505e56faca56c0f8d424cb5bdd3d}\label{class_lens_a5688505e56faca56c0f8d424cb5bdd3d}} 
\index{Lens@{Lens}!find\_image@{find\_image}}
\index{find\_image@{find\_image}!Lens@{Lens}}
\doxysubsubsection{\texorpdfstring{find\_image()}{find\_image()}\hspace{0.1cm}{\footnotesize\ttfamily [3/4]}}
{\footnotesize\ttfamily \mbox{\hyperlink{struct_r_a_y}{R\+AY}} Lens\+::find\+\_\+image (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \&}]{p,  }\item[{Pos\+Type}]{ytol2,  }\item[{Pos\+Type \&}]{dy2,  }\item[{bool}]{use\+\_\+image\+\_\+guess }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em p} & p.\+y\mbox{[}\mbox{]} should be set to source position \\
\hline
{\em ytol2} & target tolerance in source position squared \\
\hline
{\em dy2} & final value of Delta y $^\wedge$2 \\
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{class_lens_a450a498938a92acf5b73568e64f0acfe}\label{class_lens_a450a498938a92acf5b73568e64f0acfe}} 
\index{Lens@{Lens}!find\_image@{find\_image}}
\index{find\_image@{find\_image}!Lens@{Lens}}
\doxysubsubsection{\texorpdfstring{find\_image()}{find\_image()}\hspace{0.1cm}{\footnotesize\ttfamily [4/4]}}
{\footnotesize\ttfamily \mbox{\hyperlink{struct_r_a_y}{R\+AY}} Lens\+::find\+\_\+image (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_r_a_y}{R\+AY}} \&}]{p,  }\item[{Pos\+Type}]{ytol2,  }\item[{Pos\+Type \&}]{dy2,  }\item[{std\+::vector$<$ \mbox{\hyperlink{struct_point__2d}{Point\+\_\+2d}} $>$ \&}]{boundary }\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{class_lens_a7ddbfe99548eb3e63d1d45af2f005972}\label{class_lens_a7ddbfe99548eb3e63d1d45af2f005972}} 
