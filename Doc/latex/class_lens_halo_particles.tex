...
You can create a \doxylink{class_lens_halo_particles}{Lens\+Halo\+Particles$<$$>$} directly from a file, but it is recommended that you use the \doxylink{class_make_particle_lenses}{Make\+Particle\+Lenses} class to create them and then move them to a \doxylink{class_lens}{Lens} object.
