...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00031\ \textcolor{keyword}{struct\ }QBranchNB\{}
\DoxyCodeLine{00032\ \ \ QBranchNB(QBranchNB\ *parent):\mbox{\hyperlink{struct_q_branch_n_b_ae6ada2bd564b1be351ecbf1bb6c2eab2}{prev}}(parent)\{}
...
\DoxyCodeLine{00043\ \ \ \};}
\DoxyCodeLine{00044\ \ \ }
\DoxyCodeLine{00045\ \ \ \string~QBranchNB()\{\ \};}
\DoxyCodeLine{00046\ \ \ }
...
\DoxyCodeLine{00066\ \ \ }
\DoxyCodeLine{00067\ \ \ QBranchNB\ *child0;}
\DoxyCodeLine{00068\ \ \ QBranchNB\ *child1;}
\DoxyCodeLine{00069\ \ \ QBranchNB\ *child2;}
\DoxyCodeLine{00070\ \ \ QBranchNB\ *child3;}
\DoxyCodeLine{00071\ \ \ }
\DoxyCodeLine{00073\ \ \ QBranchNB\ *\mbox{\hyperlink{struct_q_branch_n_b_ae6ada2bd564b1be351ecbf1bb6c2eab2}{prev}};}
\DoxyCodeLine{00076\ \ \ QBranchNB\ *\mbox{\hyperlink{struct_q_branch_n_b_a4b80dd6d4a6859d6af1982eb7096a837}{brother}};}
\DoxyCodeLine{00077\ \ \ }
...
\DoxyCodeLine{00098\ \textcolor{keyword}{struct\ }QTreeNB\{}
\DoxyCodeLine{00099\ \ \ QTreeNB(PType\ *xp,IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{00140\ QTreeNB<PType>::QTreeNB(PType\ *xp,IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{00173\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_q_biterator_a92d757e4b48e239cdd45a6dc748b82e3}{QBiterator}}\{}
\DoxyCodeLine{00174\ \ \ }
...
\DoxyCodeLine{00225\ \textcolor{keywordtype}{short}\ QTreeNB<PType>::empty()\{}
\DoxyCodeLine{00226\ \ \ }
...
\DoxyCodeLine{00237\ \textcolor{keywordtype}{void}\ QTreeNB<PType>::\_freeQTree(\textcolor{keywordtype}{short}\ child)\{}
...
\DoxyCodeLine{00293\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ QTreeNB<PType>::isEmpty()\{}
\DoxyCodeLine{00294\ \ \ }
...
\DoxyCodeLine{00305\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ QTreeNB<PType>::atTop()\{}
\DoxyCodeLine{00306\ \ \ }
...
\DoxyCodeLine{00320\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ QTreeNB<PType>::offEnd()\{}
\DoxyCodeLine{00321\ \ \ }
...
\DoxyCodeLine{00331\ \textcolor{keywordtype}{void}\ QTreeNB<PType>::getCurrent(IndexType\ *particles,IndexType\ *nparticles)\{}
\DoxyCodeLine{00332\ \ \ }
...
\DoxyCodeLine{00350\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ QTreeNB<PType>::getNbranches()\{}
\DoxyCodeLine{00351\ \ \ }
...
\DoxyCodeLine{00363\ \textcolor{keywordtype}{void}\ QTreeNB<PType>::moveTop()\{}
...
\DoxyCodeLine{00386\ \textcolor{keywordtype}{void}\ QTreeNB<PType>::moveUp()\{}
\DoxyCodeLine{00387\ \ \ }
...
\DoxyCodeLine{00410\ \textcolor{keywordtype}{void}\ QTreeNB<PType>::moveToChild(\textcolor{keywordtype}{int}\ child)\{}
\DoxyCodeLine{00411\ \ \ }
...
\DoxyCodeLine{00448\ \textcolor{keywordtype}{void}\ QTreeNB<PType>::attachChildrenToCurrent(\mbox{\hyperlink{struct_q_branch_n_b}{QBranchNB}}\ *branch0,\mbox{\hyperlink{struct_q_branch_n_b}{QBranchNB}}\ *branch1}
...
\DoxyCodeLine{00479\ \textcolor{keywordtype}{bool}\ QTreeNB<PType>::WalkStep(\textcolor{keywordtype}{bool}\ allowDescent)\{}
...
\DoxyCodeLine{00493\ \textcolor{keywordtype}{bool}\ QBiterator<PType>::up()\{}
...
\DoxyCodeLine{00541\ \textcolor{keywordtype}{bool}\ QBiterator<PType>::TreeWalkStep(\textcolor{keywordtype}{bool}\ allowDescent)\{}
