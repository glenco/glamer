...
\DoxyCodeLine{00016\ }
\DoxyCodeLine{00020\ \textcolor{keyword}{struct\ }BranchNB\{}
\DoxyCodeLine{00021\ \ \ }
\DoxyCodeLine{00022\ \ \ BranchNB(\textcolor{keywordtype}{int}\ Ndim)\{}
...
\DoxyCodeLine{00026\ \ \ \}}
\DoxyCodeLine{00027\ \ \ \string~BranchNB()\{}
...
\DoxyCodeLine{00045\ \ \ BranchNB\ *child1;}
\DoxyCodeLine{00046\ \ \ BranchNB\ *child2;}
\DoxyCodeLine{00048\ \ \ BranchNB\ *\mbox{\hyperlink{struct_branch_n_b_a466e287cc03f291a34fe95a1f498a428}{prev}};}
\DoxyCodeLine{00051\ \ \ BranchNB\ *\mbox{\hyperlink{struct_branch_n_b_a8c9bfa3c2152686273da37ba7c587989}{brother}};}
\DoxyCodeLine{00052\ \};}
\DoxyCodeLine{00053\ }
...
\DoxyCodeLine{00086\ \textcolor{keyword}{class\ }TreeSimple\ \{}
\DoxyCodeLine{00087\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00088\ \ TreeSimple(PType\ *xp,IndexType\ Npoints,\textcolor{keywordtype}{int}\ bucket\ =\ 5,\textcolor{keywordtype}{int}\ dimensions\ =\ 2,\textcolor{keywordtype}{bool}\ median\ =\ \textcolor{keyword}{true});}
\DoxyCodeLine{00089\ \ \textcolor{keyword}{virtual}\ \string~TreeSimple();}
\DoxyCodeLine{00090\ }
...
\DoxyCodeLine{00127\ \ \ \ \ \}}
\DoxyCodeLine{00128\ }
\DoxyCodeLine{00129\ \ \ \ \ BranchNB\ *operator*()\{\textcolor{keywordflow}{return}\ current;\}}
\DoxyCodeLine{00130\ \ \ \ \ }
...
\DoxyCodeLine{00142\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00143\ \ \ \ \ \ \ }
\DoxyCodeLine{00144\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(current-\/>brother\ ==\ top-\/>brother)\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{00145\ }
...
\DoxyCodeLine{00186\ \ \ \ \ BranchNB\ *current;}
\DoxyCodeLine{00187\ \ \ \ \ BranchNB\ *top;}
\DoxyCodeLine{00188\ \ \ \};}
...
\DoxyCodeLine{00193\ \ \ TreeNBStruct<PType>*\ tree;}
...
\DoxyCodeLine{00200\ }
\DoxyCodeLine{00201\ \ TreeNBStruct<PType>*\ BuildTreeNB(PType\ *xxp,IndexType\ Nparticles,IndexType\ *particles,\textcolor{keywordtype}{int}\ Ndimensions,PosType\ theta);}
\DoxyCodeLine{00202\ \ \textcolor{keywordtype}{void}\ \_BuildTreeNB(TreeNBStruct<PType>*\ tree,IndexType\ nparticles,IndexType\ *particles);}
\DoxyCodeLine{00203\ \ \ }
...
\DoxyCodeLine{00217\ }
\DoxyCodeLine{00218\ \ BranchNB\ *\mbox{\hyperlink{class_tree_simple_a155fe08dba52e39388c12461c6efc304}{NewBranchNB}}(IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{00221\ \ \textcolor{keywordtype}{void}\ FreeBranchNB(BranchNB\ *branchNB);}
\DoxyCodeLine{00222\ \ TreeNBStruct<PType>\ *\ NewTreeNB(IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{00225\ \ \textcolor{keywordtype}{void}\ freeTreeNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00226\ \ \textcolor{keywordtype}{short}\ emptyTreeNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00227\ \ \textcolor{keywordtype}{void}\ \_freeTreeNB(TreeNBStruct<PType>\ *\ tree,\textcolor{keywordtype}{short}\ child);}
\DoxyCodeLine{00228\ \ \textcolor{keywordtype}{bool}\ isEmptyNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00229\ \ \textcolor{keywordtype}{bool}\ atTopNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00230\ \ \textcolor{keywordtype}{bool}\ noChildNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00231\ \ \textcolor{keywordtype}{bool}\ offEndNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00232\ \ \textcolor{keywordtype}{void}\ getCurrentNB(TreeNBStruct<PType>\ *\ tree,IndexType\ *particles,IndexType\ *nparticles);}
\DoxyCodeLine{00233\ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ getNbranchesNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00234\ \ \textcolor{keywordtype}{void}\ moveTopNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00235\ \ \textcolor{keywordtype}{void}\ moveUpNB(TreeNBStruct<PType>\ *\ tree);}
\DoxyCodeLine{00236\ \ \textcolor{keywordtype}{void}\ moveToChildNB(TreeNBStruct<PType>\ *\ tree,\textcolor{keywordtype}{int}\ child);}
\DoxyCodeLine{00237\ \ \textcolor{keywordtype}{void}\ insertChildToCurrentNB(TreeNBStruct<PType>\ *\ tree,\ IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{00240\ \ \textcolor{keywordtype}{void}\ attachChildToCurrentNB(TreeNBStruct<PType>\ *\ tree,BranchNB\ \&data,\textcolor{keywordtype}{int}\ child);}
\DoxyCodeLine{00241\ \ \textcolor{keywordtype}{bool}\ TreeNBWalkStep(TreeNBStruct<PType>\ *\ tree,\textcolor{keywordtype}{bool}\ allowDescent);}
\DoxyCodeLine{00242\ }
...
\DoxyCodeLine{00264\ TreeSimple<PType>::TreeSimple(PType\ *xpt,IndexType\ Npoints,\textcolor{keywordtype}{int}\ bucket,\textcolor{keywordtype}{int}\ Ndimensions,\textcolor{keywordtype}{bool}\ median)\{}
...
\DoxyCodeLine{00283\ TreeSimple<PType>::\string~TreeSimple()}
\DoxyCodeLine{00284\ \{}
...
\DoxyCodeLine{00307\ \ \ \mbox{\hyperlink{class_tree_simple_af6cbac2c13bdb37f107eb411877bdfea}{PointsWithinCircle}}(ray,rmax,neighborlist);}
\DoxyCodeLine{00308\ \ \ }
...
\DoxyCodeLine{00336\ \ \ \textcolor{keywordflow}{if}(\ inbox(ray,tree-\/>current-\/>boundary\_p1,tree-\/>current-\/>boundary\_p2)\ ==\ 0\ )\{}
\DoxyCodeLine{00337\ \ \ \ \ }
\DoxyCodeLine{00338\ \ \ \ \ ray[0]\ =\ (ray[0]\ >\ tree-\/>current-\/>boundary\_p1[0])\ ?\ ray[0]\ :\ tree-\/>current-\/>boundary\_p1[0];}
\DoxyCodeLine{00339\ \ \ \ \ ray[0]\ =\ (ray[0]\ <\ tree-\/>current-\/>boundary\_p2[0])\ ?\ ray[0]\ :\ tree-\/>current-\/>boundary\_p2[0];}
\DoxyCodeLine{00340\ \ \ \ \ }
\DoxyCodeLine{00341\ \ \ \ \ ray[1]\ =\ (ray[1]\ >\ tree-\/>current-\/>boundary\_p1[1])\ ?\ ray[1]\ :\ tree-\/>current-\/>boundary\_p1[1];}
\DoxyCodeLine{00342\ \ \ \ \ ray[1]\ =\ (ray[1]\ <\ tree-\/>current-\/>boundary\_p2[1])\ ?\ ray[1]\ :\ tree-\/>current-\/>boundary\_p2[1];}
\DoxyCodeLine{00343\ \ \ \ \ }
...
\DoxyCodeLine{00352\ \ \ }
\DoxyCodeLine{00353\ \ \ \mbox{\hyperlink{class_tree_simple_a00689f8ece60bd298e376a1d16dd08da}{\_PointsWithin<T>}}(ray,\&rmax,neighborlist);}
\DoxyCodeLine{00354\ \ \ }
...
\DoxyCodeLine{00369\ \ \ \ \ }
\DoxyCodeLine{00370\ \ \ \ \ \textcolor{keywordflow}{if}(\ inbox(ray,tree-\/>current-\/>boundary\_p1,tree-\/>current-\/>boundary\_p2)\ )\{}
\DoxyCodeLine{00371\ \ \ \ \ \ \ \textcolor{comment}{//cout\ <<\ "{}\ \ \ In\ box"{}\ <<\ endl;}}
\DoxyCodeLine{00372\ \ \ \ \ \ \ }
\DoxyCodeLine{00373\ \ \ \ \ \ \ \textcolor{comment}{//\ found\ the\ box\ small\ enough}}
\DoxyCodeLine{00374\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ Utilities::cutbox(ray,tree-\/>current-\/>boundary\_p1,tree-\/>current-\/>boundary\_p2,*rmax)==1}
...
\DoxyCodeLine{00388\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(j=0,radius=0.0;j<2;++j)\ radius+=pow(xxp[tree-\/>current-\/>particles[i]][j]-\/ray[j],2);}
\DoxyCodeLine{00389\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ radius\ <\ *rmax**rmax\ )\{}
\DoxyCodeLine{00390\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ neighborlist.push\_back(tree-\/>current-\/>particles[i]);}
...
\DoxyCodeLine{00397\ \ \ \ \ \ \ \ \ \ \ \ \ neighborlist.push\_back(tree-\/>current-\/>particles[i]);}
...
\DoxyCodeLine{00408\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_a00689f8ece60bd298e376a1d16dd08da}{\_PointsWithin}}(ray,rmax,neighborlist);}
...
\DoxyCodeLine{00416\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_a00689f8ece60bd298e376a1d16dd08da}{\_PointsWithin}}(ray,rmax,neighborlist);}
...
\DoxyCodeLine{00424\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_a00689f8ece60bd298e376a1d16dd08da}{\_PointsWithin}}(ray,rmax,neighborlist);}
...
\DoxyCodeLine{00432\ \ \ \ \ }
\DoxyCodeLine{00433\ \ \ \ \ pass=Utilities::cutbox(ray,tree-\/>current-\/>boundary\_p1,tree-\/>current-\/>boundary\_p2,*rmax);}
...
\DoxyCodeLine{00440\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(j=0,radius=0.0;j<2;++j)\ radius+=pow(xxp[tree-\/>current-\/>particles[i]][j]-\/ray[j],2);}
\DoxyCodeLine{00441\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ radius\ <\ *rmax**rmax\ )\{}
\DoxyCodeLine{00442\ \ \ \ \ \ \ \ \ \ \ \ \ neighborlist.push\_back(tree-\/>current-\/>particles[i]);}
...
\DoxyCodeLine{00451\ \ \ \ \ \ \ \ \ \ \ neighborlist.push\_back(tree-\/>current-\/>particles[i]);}
...
\DoxyCodeLine{00459\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_a00689f8ece60bd298e376a1d16dd08da}{\_PointsWithin}}(ray,rmax,neighborlist);}
...
\DoxyCodeLine{00465\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_a00689f8ece60bd298e376a1d16dd08da}{\_PointsWithin}}(ray,rmax,neighborlist);}
...
\DoxyCodeLine{00498\ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int}\ j=0;j<tree-\/>Ndimensions;++j)\{}
\DoxyCodeLine{00499\ \ \ \ \ \ \ tmp[j]\ =\ (ray[j]\ >\ tree-\/>current-\/>boundary\_p1[j])\ ?\ ray[j]\ :\ tree-\/>current-\/>boundary\_p1[j];}
\DoxyCodeLine{00500\ \ \ \ \ \ \ tmp[j]\ =\ (ray[j]\ <\ tree-\/>current-\/>boundary\_p2[j])\ ?\ tmp[j]\ :\ tree-\/>current-\/>boundary\_p2[j];}
\DoxyCodeLine{00501\ \ \ \ \ \}}
\DoxyCodeLine{00502\ \ \ \ \ }
...
\DoxyCodeLine{00522\ \ \ \ \ \ \ r2\ +=\ pow(tree-\/>pp[(*iter)-\/>particles[i]][j]-\/ray[j],2);}
\DoxyCodeLine{00523\ \ \ \ \ \}}
...
\DoxyCodeLine{00531\ \ \ \ \ \ \ r2\ +=\ pow(tree-\/>pp[(*iter)-\/>particles[i]][j]-\/ray[j],2);}
\DoxyCodeLine{00532\ \ \ \ \ \}}
...
\DoxyCodeLine{00593\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ r2\ +=\ pow(tree-\/>pp[cbranch-\/>\mbox{\hyperlink{struct_branch_n_b_a1dcccbca6f9e700359d056d586045750}{particles}}[i]][j]-\/ray[j],2);}
\DoxyCodeLine{00594\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00595\ \ \ \ \ \ \ \ \ \ \ }
...
\DoxyCodeLine{00625\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::\_findleaf(T\ *ray,TreeSimple::iterator\ \&it)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00626\ \ \ }
...
\DoxyCodeLine{00755\ \ \ \ \ }
\DoxyCodeLine{00756\ \ \ \ \ \textcolor{keywordflow}{if}(\ inbox(ray,tree-\/>current-\/>boundary\_p1,tree-\/>current-\/>boundary\_p2)\ )\{}
\DoxyCodeLine{00757\ \ \ \ \ \ \ }
...
\DoxyCodeLine{00761\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(j=0;j<tree-\/>Ndimensions;++j)\ ray[j]=realray[j];}
\DoxyCodeLine{00762\ \ \ \ \ \ \ \ \ }
...
\DoxyCodeLine{00765\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(j=0,rneighbors[i]=0.0;j<tree-\/>Ndimensions;++j)\{}
\DoxyCodeLine{00766\ \ \ \ \ \ \ \ \ \ \ \ \ rneighbors[i]\ +=\ pow(tree-\/>xp[tree-\/>current-\/>particles[i]][j]-\/ray[j],2);}
\DoxyCodeLine{00767\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00768\ \ \ \ \ \ \ \ \ \ \ rneighbors[i]=sqrt(\ rneighbors[i]\ );}
\DoxyCodeLine{00769\ \ \ \ \ \ \ \ \ \ \ assert(rneighbors[i]\ <\ 10);}
\DoxyCodeLine{00770\ \ \ \ \ \ \ \ \ \ \ neighbors[i]=tree-\/>current-\/>particles[i];}
\DoxyCodeLine{00771\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00772\ \ \ \ \ \ \ \ \ }
...
\DoxyCodeLine{00779\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_acdaf208f665887ce9d2b6e27005548a7}{\_NearestNeighbors}}(ray,Nneighbors,neighbors,rneighbors);}
...
\DoxyCodeLine{00789\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_acdaf208f665887ce9d2b6e27005548a7}{\_NearestNeighbors}}(ray,Nneighbors,neighbors,rneighbors);}
...
\DoxyCodeLine{00798\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_acdaf208f665887ce9d2b6e27005548a7}{\_NearestNeighbors}}(ray,Nneighbors,neighbors,rneighbors);}
...
\DoxyCodeLine{00806\ \ \ \ \ \textcolor{keywordflow}{if}(\ Utilities::cutbox(ray,tree-\/>current-\/>boundary\_p1,tree-\/>current-\/>boundary\_p2,rneighbors[Nneighbors-\/1])\ )\{}
\DoxyCodeLine{00807\ \ \ \ \ \ \ }
...
\DoxyCodeLine{00812\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}(j=0,rneighbors[i]=0.0;j<tree-\/>Ndimensions;++j)\{}
\DoxyCodeLine{00813\ \ \ \ \ \ \ \ \ \ \ \ \ rneighbors[i]+=pow(tree-\/>xp[tree-\/>current-\/>particles[i-\/Nneighbors]][j]-\/ray[j],2);}
\DoxyCodeLine{00814\ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00815\ \ \ \ \ \ \ \ \ \ \ rneighbors[i]=sqrt(\ rneighbors[i]\ );}
\DoxyCodeLine{00816\ \ \ \ \ \ \ \ \ \ \ assert(rneighbors[i]\ <\ 10);}
\DoxyCodeLine{00817\ \ \ \ \ \ \ \ \ \ \ neighbors[i]=tree-\/>current-\/>particles[i-\/Nneighbors];}
\DoxyCodeLine{00818\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00819\ \ \ \ \ \ \ \ \ }
...
\DoxyCodeLine{00826\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_acdaf208f665887ce9d2b6e27005548a7}{\_NearestNeighbors}}(ray,Nneighbors,neighbors,rneighbors);}
...
\DoxyCodeLine{00832\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_tree_simple_acdaf208f665887ce9d2b6e27005548a7}{\_NearestNeighbors}}(ray,Nneighbors,neighbors,rneighbors);}
...
\DoxyCodeLine{00842\ \mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ TreeSimple<PType>::BuildTreeNB(PType\ *xp,IndexType\ Nparticles,IndexType\ *particles,\textcolor{keywordtype}{int}\ Ndims}
...
\DoxyCodeLine{00882\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::\_BuildTreeNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,IndexType\ nparticles,IndexType\ *particles)\{}
...
\DoxyCodeLine{01030\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::FreeBranchNB(\mbox{\hyperlink{struct_branch_n_b}{BranchNB}}\ *branchNB)\{}
\DoxyCodeLine{01031\ \ \ }
...
\DoxyCodeLine{01044\ \mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ TreeSimple<PType>::NewTreeNB(IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{01070\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::freeTreeNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
...
\DoxyCodeLine{01085\ \textcolor{keywordtype}{short}\ TreeSimple<PType>::emptyTreeNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01086\ \ \ }
...
\DoxyCodeLine{01096\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::\_freeTreeNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,\textcolor{keywordtype}{short}\ child)\{}
...
\DoxyCodeLine{01139\ \textcolor{keywordtype}{bool}\ TreeSimple<PType>::isEmptyNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01140\ \ \ }
...
\DoxyCodeLine{01152\ \textcolor{keywordtype}{bool}\ TreeSimple<PType>::atTopNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01153\ \ \ }
...
\DoxyCodeLine{01170\ \textcolor{keywordtype}{bool}\ TreeSimple<PType>::noChildNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01171\ \ \ }
...
\DoxyCodeLine{01188\ \textcolor{keywordtype}{bool}\ TreeSimple<PType>::offEndNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01189\ \ \ }
...
\DoxyCodeLine{01200\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::getCurrentNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,IndexType\ *particles,IndexType\ *nparticles)\{}
\DoxyCodeLine{01201\ \ \ }
...
\DoxyCodeLine{01220\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ TreeSimple<PType>::getNbranchesNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01221\ \ \ }
...
\DoxyCodeLine{01234\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::moveTopNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
...
\DoxyCodeLine{01259\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::moveUpNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree)\{}
\DoxyCodeLine{01260\ \ \ }
...
\DoxyCodeLine{01282\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::moveToChildNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,\textcolor{keywordtype}{int}\ child)\{}
\DoxyCodeLine{01283\ \ \ }
...
\DoxyCodeLine{01314\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::insertChildToCurrentNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,\ IndexType\ *particles,IndexType\ nparticles}
...
\DoxyCodeLine{01359\ \textcolor{keywordtype}{void}\ TreeSimple<PType>::attachChildToCurrentNB(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,\mbox{\hyperlink{struct_branch_n_b}{BranchNB}}\ \&data,\textcolor{keywordtype}{int}\ child)\{}
\DoxyCodeLine{01360\ \ \ }
...
\DoxyCodeLine{01368\ \textcolor{keywordtype}{bool}\ TreeSimple<PType>::TreeNBWalkStep(\mbox{\hyperlink{struct_tree_n_b_struct}{TreeNBStruct<PType>}}\ *\ tree,\textcolor{keywordtype}{bool}\ allowDescent)\{}
