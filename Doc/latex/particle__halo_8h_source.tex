...
\DoxyCodeLine{00040\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}}
\DoxyCodeLine{00041\ \{}
...
\DoxyCodeLine{00067\ \ \ ):\mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(redshift,cosmo),min\_size(MinPSize),multimass(true),inv\_area(my\_inv\_area)}
\DoxyCodeLine{00068\ \ \ \{}
...
\DoxyCodeLine{00089\ \ \ ):\mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(redshift,cosmo),min\_size(MinPSize),multimass(true),inv\_area(my\_inv\_area),Npoints(n)}
\DoxyCodeLine{00090\ \ \ \{}
...
\DoxyCodeLine{00113\ \ \ \}}
\DoxyCodeLine{00114\ \ \ \mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles<PType>}}\ \&\ operator=(\mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles<PType>}}\ \&\&h);}
\DoxyCodeLine{00115\ }
\DoxyCodeLine{00116\ }
...
\DoxyCodeLine{00142\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ );}
\DoxyCodeLine{00143\ \ \ }
\DoxyCodeLine{00148\ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles<ParticleTypeSimple>}}\ \mbox{\hyperlink{class_lens_halo_particles_a46def593bc40d817ca3c45d521b700ce}{SIE}}(}
...
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }MakeParticleLenses;}
\DoxyCodeLine{00179\ \ \ }
...
\DoxyCodeLine{00184\ \ \ ):\ \mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(redshift,cosmo)\{\}}
\DoxyCodeLine{00185\ }
...
\DoxyCodeLine{00196\ \ \ ):\mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(redshift,cosmo),pp(pdata),min\_size(0),multimass(true),Npoints(Nparticles),inv\_area(my\_inv\_area)}
\DoxyCodeLine{00197\ \ \ \{}
...
\DoxyCodeLine{00240\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00241\ :\mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(redshift,cosmo),min\_size(MinPSize),multimass(my\_multimass),simfile(simulation\_filename),inv\_area(my\_inv\_area)}
\DoxyCodeLine{00242\ \{}
\DoxyCodeLine{00243\ \ \ }
...
\DoxyCodeLine{00422\ LensHaloParticles<PType>::\string~LensHaloParticles()\{}
...
\DoxyCodeLine{00427\ \textcolor{keywordtype}{void}\ LensHaloParticles<PType>::force\_halo(\textcolor{keywordtype}{double}\ *alpha,KappaType\ *kappa,KappaType\ *gamma,KappaType\ *phi}
...
\DoxyCodeLine{00557\ \textcolor{keywordtype}{bool}\ LensHaloParticles<PType>::readSizesFile(\textcolor{keyword}{const}\ std::string\ \&filename}
...
\DoxyCodeLine{00635\ \textcolor{keywordtype}{void}\ LensHaloParticles<PType>::rotate\_particles(PosType\ theta\_x,PosType\ theta\_y)\{}
\DoxyCodeLine{00636\ \ \ }
...
\DoxyCodeLine{00683\ \textcolor{keywordtype}{void}\ LensHaloParticles<PType>::calculate\_smoothing(\textcolor{keywordtype}{int}\ Nsmooth,PType\ *pp}
...
\DoxyCodeLine{00713\ \ \ \ \ \ \ }
\DoxyCodeLine{00714\ \ \ \ \ \ \ thr[ii]\ =\ std::thread(LensHaloParticles<PType>::smooth\_,\&tree3d}
...
\DoxyCodeLine{00724\ \textcolor{keywordtype}{void}\ LensHaloParticles<PType>::smooth\_(\mbox{\hyperlink{class_tree_simple}{TreeSimple<PType>}}\ *tree3d,PType\ *pp,\textcolor{keywordtype}{size\_t}\ N,\textcolor{keywordtype}{int}\ Nsmooth)\{}
\DoxyCodeLine{00725\ \ \ }
...
\DoxyCodeLine{00734\ \textcolor{keywordtype}{void}\ LensHaloParticles<PType>::writeSizes(\textcolor{keyword}{const}\ std::string\ \&filename,\textcolor{keywordtype}{int}\ Nsmooth}
...
\DoxyCodeLine{00805\ \ \ \mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles<ParticleTypeSimple>}}\ \mbox{\hyperlink{class_lens_halo_particles_a46def593bc40d817ca3c45d521b700ce}{LensHaloParticles<PType>::SIE}}(}
...
\DoxyCodeLine{00841\ \ \ \ \ \}}
\DoxyCodeLine{00842\ \ \ \ \ }
\DoxyCodeLine{00843\ \ \ \ \ \mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles<ParticleTypeSimple>\ ::calculate\_smoothing}}(Nneighbors,parts.data(),Npoints);}
\DoxyCodeLine{00844\ }
\DoxyCodeLine{00845\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_lens_halo_particles_a9930f80c98af4265ecd12f72419aa7fa}{LensHaloParticles<ParticleTypeSimple>}}(parts,redshift}
...
\DoxyCodeLine{00850\ \mbox{\hyperlink{class_lens_halo_particles}{LensHaloParticles<PType>}}\ \&\ LensHaloParticles<PType>::operator=(\mbox{\hyperlink{class_lens_halo_particles}{LensHaloParticles<PType>}}\ \&\&h)\{}
...
\DoxyCodeLine{00872\ }
\DoxyCodeLine{00873\ }
\DoxyCodeLine{00964\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_make_particle_lenses_a3f1a58c230e3dd6ed936179473353cb8}{MakeParticleLenses}}\{}
\DoxyCodeLine{00965\ \ \ }
...
\DoxyCodeLine{01000\ }
\DoxyCodeLine{01001\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_make_particle_lenses_a630543b97c4e4e571852e4accbb065b4}{CreateHalos}}(\textcolor{keyword}{const}\ COSMOLOGY\ \&cosmo,\textcolor{keywordtype}{double}\ redshift,\textcolor{keywordtype}{double}\ inv\_area);}
\DoxyCodeLine{01002\ \ \ }
...
\DoxyCodeLine{01006\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_make_particle_lenses_a55fa4825f80d5020b01691f66012d713}{cylindricalCut}}(Point\_2d\ center,\textcolor{keywordtype}{double}\ radius);}
\DoxyCodeLine{01007\ }
...
\DoxyCodeLine{01010\ \ \ }
\DoxyCodeLine{01012\ \ \ Point\_3d<>\ \mbox{\hyperlink{class_make_particle_lenses_a4a1407a9d50912c085e43660a807354e}{densest\_particle}}();}
\DoxyCodeLine{01013\ }
...
\DoxyCodeLine{01098\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,\textcolor{keyword}{const}\ COSMOLOGY\&\ cosmo\ \ }
...
\DoxyCodeLine{01103\ \ \ ):\mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(redshift,cosmo),inv\_area(inv\_area),theta\_force(my\_theta\_force),periodic\_buffer(mu\_periodic\_buffer)}
\DoxyCodeLine{01104\ \ \ \{}
...
\DoxyCodeLine{01113\ \ \ }
\DoxyCodeLine{01114\ \ \ LensHaloHalos(LensHaloHalos\ \&\&h):\mbox{\hyperlink{class_lens_halo_a813618bcd6d1f26dafa49a2e509a37db}{LensHalo}}(std::move(h))\{}
...
\DoxyCodeLine{01135\ \ \ }
\DoxyCodeLine{01137\ \ \ Point\_2d\ CenterOfMass()\{\textcolor{keywordflow}{return}\ mcenter;\}}
\DoxyCodeLine{01138\ \ \ }
\DoxyCodeLine{01139\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{01140\ \ \ Point\_2d\ mcenter;}
...
\DoxyCodeLine{01145\ \ \ }
\DoxyCodeLine{01146\ \ \ Utilities::Geometry::SphericalPoint<>\ center;}
\DoxyCodeLine{01147\ \ \ }
...
\DoxyCodeLine{01154\ \ \ }
\DoxyCodeLine{01155\ \ \ \textcolor{keywordtype}{void}\ set\_up(\textcolor{keywordtype}{float}\ redshift,\textcolor{keyword}{const}\ COSMOLOGY\&\ cosmo,\textcolor{keywordtype}{bool}\ verbose);}
\DoxyCodeLine{01156\ \};}
\DoxyCodeLine{01157\ }
