...
First you must create an instance of the {\ttfamily C\+O\+S\+M\+O\+L\+O\+GY} class. This is taken as an argument to many of the constructors and contains functions for calculating cosmological quantities. Several standard cosmological parameters sets are available or a new set can be chosen.\hypertarget{index_autotoc_md16}{}\doxysection{Lens\+Halo classes}\label{index_autotoc_md16}
