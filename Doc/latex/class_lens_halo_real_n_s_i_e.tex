...
\item 
\mbox{\hyperlink{class_lens_halo_real_n_s_i_e_a6740f067c19676e37d7cf85ae695eefb}{Lens\+Halo\+Real\+N\+S\+IE}} (float my\+\_\+mass, Pos\+Type my\+\_\+zlens, float my\+\_\+sigma, float my\+\_\+rcore, float my\+\_\+fratio, float my\+\_\+pa, const C\+O\+S\+M\+O\+L\+O\+GY \&cosmo)
...
{\footnotesize\ttfamily Lens\+Halo\+Real\+N\+S\+I\+E\+::\+Lens\+Halo\+Real\+N\+S\+IE (\begin{DoxyParamCaption}\item[{float}]{my\+\_\+mass,  }\item[{Pos\+Type}]{my\+\_\+zlens,  }\item[{float}]{my\+\_\+sigma,  }\item[{float}]{my\+\_\+rcore,  }\item[{float}]{my\+\_\+fratio,  }\item[{float}]{my\+\_\+pa,  }\item[{const C\+O\+S\+M\+O\+L\+O\+GY \&}]{cosmo }\end{DoxyParamCaption})}
