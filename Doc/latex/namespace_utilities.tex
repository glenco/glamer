...
\begin{DoxyCompactList}\small\item\em Gives a randomized sequence of numbers from 0 to N-\/1. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item 
{\footnotesize template$<$class T $>$ }\\int long \mbox{\hyperlink{namespace_utilities_a7bd6a986fd81b85b290cd9ab0034e3f8}{locate}} (const std\+::vector$<$ T $>$ \&v, const T x)
\item 
{\footnotesize template$<$class T , class F $>$ }\\int \mbox{\hyperlink{namespace_utilities_af07d27fc678946de3bc659e5d7f9feda}{locate}} (const std\+::vector$<$ T $>$ \&v, F x, std\+::function$<$ bool(F, const T \&)$>$ less\+\_\+than)
\item 
...
\item 
\mbox{\Hypertarget{namespace_utilities_acf0c3070a8f69f72a2f32a39f17ca277}\label{namespace_utilities_acf0c3070a8f69f72a2f32a39f17ca277}} 
void {\bfseries quicksort} (unsigned long $\ast$particles, Pos\+Type $\ast$arr, unsigned long N)
\item 
\mbox{\Hypertarget{namespace_utilities_ae9e7113bef6d90e6e85d0b25eaf06c93}\label{namespace_utilities_ae9e7113bef6d90e6e85d0b25eaf06c93}} 
void {\bfseries quick\+Partition} (Pos\+Type pivotvalue, unsigned long $\ast$pivotindex, unsigned long $\ast$particles, Pos\+Type $\ast$arr, unsigned long N)
\item 
\mbox{\Hypertarget{namespace_utilities_a16748f779b70435ba98cef668ba62ac4}\label{namespace_utilities_a16748f779b70435ba98cef668ba62ac4}} 
void {\bfseries quick\+Partition\+Points} (Pos\+Type pivotvalue, unsigned long $\ast$pivotindex, \mbox{\hyperlink{struct_point}{Point}} $\ast$pointsarray, Pos\+Type $\ast$arr, unsigned long N)
\item 
\mbox{\Hypertarget{namespace_utilities_a9cb92660db855441bddb128d39fb968b}\label{namespace_utilities_a9cb92660db855441bddb128d39fb968b}} 
void {\bfseries quick\+Partition\+Points} (Pos\+Type pivotvalue, unsigned long $\ast$pivotindex, \mbox{\hyperlink{struct_point}{Point}} $\ast$pointarray, Pos\+Type($\ast$func)(\mbox{\hyperlink{struct_point}{Point}} \&p), unsigned long N)
\item 
...
\item 
\mbox{\Hypertarget{namespace_utilities_aca843ce18cb36d8002f0878719ef7f24}\label{namespace_utilities_aca843ce18cb36d8002f0878719ef7f24}} 
{\footnotesize template$<$typename T $>$ }\\int {\bfseries cutbox} (const T $\ast$center, Pos\+Type $\ast$p1, Pos\+Type $\ast$p2, float rmax)
\item 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{namespace_utilities_a7bd6a986fd81b85b290cd9ab0034e3f8}\label{namespace_utilities_a7bd6a986fd81b85b290cd9ab0034e3f8}} 
\index{Utilities@{Utilities}!locate@{locate}}
\index{locate@{locate}!Utilities@{Utilities}}
\doxysubsubsection{\texorpdfstring{locate()}{locate()}\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
{\footnotesize\ttfamily template$<$class T $>$ \\
int long Utilities\+::locate (\begin{DoxyParamCaption}\item[{const std\+::vector$<$ T $>$ \&}]{v,  }\item[{const T}]{x }\end{DoxyParamCaption})}

Locates the element of the given vector which, together with the following element, brackets the given number. If x is smaller than the smallest entry or larger than the largest, the result is either -\/1 or n-\/1. \mbox{\Hypertarget{namespace_utilities_af07d27fc678946de3bc659e5d7f9feda}\label{namespace_utilities_af07d27fc678946de3bc659e5d7f9feda}} 
\index{Utilities@{Utilities}!locate@{locate}}
\index{locate@{locate}!Utilities@{Utilities}}
...
int Utilities\+::locate (\begin{DoxyParamCaption}\item[{const std\+::vector$<$ T $>$ \&}]{v,  }\item[{F}]{x,  }\item[{std\+::function$<$ bool(F, const T \&)$>$}]{less\+\_\+than }\end{DoxyParamCaption})}
