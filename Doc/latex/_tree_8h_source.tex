...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00031\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_tree_struct_a20fc537aab17f735ce8c6bac7d95af87}{TreeStruct}}\{}
\DoxyCodeLine{00032\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00033\ \ \ \mbox{\hyperlink{struct_tree_struct_a20fc537aab17f735ce8c6bac7d95af87}{TreeStruct}}(\mbox{\hyperlink{struct_point}{Point}}\ *xp,\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints,\textcolor{keywordtype}{short}\ my\_median\_cut\ =\ 1,PosType\ buffer\ =\ 0.0);}
\DoxyCodeLine{00034\ \ \ \mbox{\hyperlink{struct_tree_struct_a20fc537aab17f735ce8c6bac7d95af87}{TreeStruct}}(\mbox{\hyperlink{struct_point}{Point}}\ *xp,\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ npoints}
...
\DoxyCodeLine{00039\ \ \ }
\DoxyCodeLine{00047\ \ \ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_tree_struct_1_1iterator_a806e9121b2d02cc6acbd5a975f20801d}{iterator}}\{}
\DoxyCodeLine{00048\ \ \ \ \ }
...
\DoxyCodeLine{00055\ \ \ \ \ \mbox{\hyperlink{class_tree_struct_1_1iterator_a806e9121b2d02cc6acbd5a975f20801d}{iterator}}(\mbox{\hyperlink{struct_tree_struct_a20fc537aab17f735ce8c6bac7d95af87}{TreeStruct}}\ *\ tree)\{current\ =\ top\ =\ tree-\/>top\_ptr.get();\}}
...
\DoxyCodeLine{00072\ \ \ \ \ \}}
\DoxyCodeLine{00073\ \ \ \ \ }
\DoxyCodeLine{00074\ \ \ \ \ \mbox{\hyperlink{class_tree_struct_1_1iterator_a806e9121b2d02cc6acbd5a975f20801d}{iterator}}\ \&operator=(Branch\ *branch)\{}
...
\DoxyCodeLine{00109\ \ \ \};}
\DoxyCodeLine{00110\ \ \ }
\DoxyCodeLine{00111\ \ \ TreeStruct::iterator\ begin()\textcolor{keyword}{\ const}\{}
\DoxyCodeLine{00112\ \ \ \ \ \mbox{\hyperlink{class_tree_struct_1_1iterator}{iterator}}\ it(top\_ptr.get());}
\DoxyCodeLine{00113\ \ \ \ \ \textcolor{keywordflow}{return}\ it;}
\DoxyCodeLine{00114\ \ \ \};}
\DoxyCodeLine{00115\ \ \ }
\DoxyCodeLine{00116\ \ \ TreeStruct::iterator\ end()\textcolor{keyword}{\ const}\{}
\DoxyCodeLine{00117\ \ \ \ \ \mbox{\hyperlink{class_tree_struct_1_1iterator}{iterator}}\ it(top\_ptr-\/>brother);}
...
\DoxyCodeLine{00168\ }
\DoxyCodeLine{00169\ \ \ \mbox{\hyperlink{struct_tree_struct_a20fc537aab17f735ce8c6bac7d95af87}{TreeStruct}}()\{\};}
...
\DoxyCodeLine{00209\ \};}
\DoxyCodeLine{00210\ }
\DoxyCodeLine{00211\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_tree_struct}{TreeStruct}}\ *TreeHndl;}
...
\DoxyCodeLine{00247\ }
\DoxyCodeLine{00248\ \textcolor{keywordtype}{void}\ saveTree(TreeHndl\ tree,\textcolor{keywordtype}{char}\ *filename);}
\DoxyCodeLine{00249\ TreeHndl\ readTree(\textcolor{keywordtype}{char}\ *filename);}
\DoxyCodeLine{00250\ }
\DoxyCodeLine{00252\ }
...
\DoxyCodeLine{00293\ }
\DoxyCodeLine{00294\ \textcolor{keywordtype}{void}\ findborders2(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_old_image_info}{OldImageInfo}}\ *imageinfo);}
\DoxyCodeLine{00295\ \textcolor{keywordtype}{void}\ findborders3(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_old_image_info}{OldImageInfo}}\ *imageinfo);}
\DoxyCodeLine{00296\ }
\DoxyCodeLine{00297\ \textcolor{comment}{//\ in\ image\_finder\_kist.c}}
\DoxyCodeLine{00298\ }
\DoxyCodeLine{00299\ \textcolor{keywordtype}{void}\ findborders4(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_image_info}{ImageInfo}}\ *imageinfo,\textcolor{keywordtype}{bool}\ \&touches\_boundary);}
\DoxyCodeLine{00300\ }
\DoxyCodeLine{00301\ \textcolor{comment}{//\ in\ find\_crit.c}}
\DoxyCodeLine{00302\ \textcolor{keywordtype}{void}\ findborders(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_image_info}{ImageInfo}}\ *imageinfo);}
\DoxyCodeLine{00303\ }
...
\DoxyCodeLine{00428\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,Point\ *pointarray,T\ *arr,\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ N)\{}
...
\DoxyCodeLine{00447\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ,Point\ *pointarray,T\ (*func)(Point\ \&p),\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ N)\{}
...
\DoxyCodeLine{00464\ }
\DoxyCodeLine{00465\ }
\DoxyCodeLine{00466\ \textcolor{keywordtype}{void}\ log\_polar\_grid(Point\ *i\_points,PosType\ rmax,PosType\ rmin,PosType\ *center,\textcolor{keywordtype}{long}\ Ngrid);}
\DoxyCodeLine{00467\ \textcolor{keywordtype}{void}\ findarea(ImageInfo\ *imageinfo);}
\DoxyCodeLine{00468\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespace_utilities_a7771b5ff9b3034f364adcee471cb754d}{writeCurves}}(\textcolor{keywordtype}{int}\ m,\ ImageInfo\ *critical,\ \textcolor{keywordtype}{int}\ Ncrit,\ \textcolor{keywordtype}{int}\ index);}
\DoxyCodeLine{00469\ PosType\ cross(\textcolor{keyword}{const}\ Point\ *O,\ \textcolor{keyword}{const}\ Point\ *A,\ \textcolor{keyword}{const}\ Point\ *B);}
\DoxyCodeLine{00470\ \textcolor{keywordtype}{bool}\ xorder(Point\ *p1,Point\ *p2);}
\DoxyCodeLine{00471\ \textcolor{keywordtype}{bool}\ yorder(Point\ *p1,Point\ *p2);}
\DoxyCodeLine{00472\ \textcolor{comment}{//}}
\DoxyCodeLine{00473\ }
\DoxyCodeLine{00474\ PosType\ cross(\textcolor{keyword}{const}\ Point\ *O,\ \textcolor{keyword}{const}\ Point\ *A,\ \textcolor{keyword}{const}\ Point\ *B);}
...
\DoxyCodeLine{00476\ PosType\ crossD(\textcolor{keyword}{const}\ Point\_2d\ \&O,\textcolor{keyword}{const}\ Point\_2d\ \&A,\textcolor{keyword}{const}\ Point\_2d\ \&B);}
\DoxyCodeLine{00477\ }
...
\DoxyCodeLine{00484\ }
\DoxyCodeLine{00485\ }
\DoxyCodeLine{00486\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespace_utilities_ac71ef3b7c0383a2ca61eb5d479d8490d}{contour\_ellipse}}(std::vector<Point\_2d>\ \&P,\ Point\_2d\ center,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints\ ,std::vector<Point\_2d>\ \&C,\ \textcolor{keywordtype}{double}\ *ellipticity,\ \textcolor{keywordtype}{double}\ *ellipse\_area)\ ;}
\DoxyCodeLine{00487\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespace_utilities_ac71ef3b7c0383a2ca61eb5d479d8490d}{contour\_ellipse}}(std::vector<RAY>\ \&P,\ Point\_2d\ center,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints\ ,std::vector<Point\_2d>\ \&C,\ \textcolor{keywordtype}{double}\ *ellipticity,\ \textcolor{keywordtype}{double}\ *ellipse\_area)\ ;}
\DoxyCodeLine{00488\ Point\_2d\ \mbox{\hyperlink{namespace_utilities_a512d73667d76a5a58e44042a4a73c974}{contour\_center}}(std::vector<Point\_2d>\ \&P,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints);}
\DoxyCodeLine{00489\ Point\_2d\ \mbox{\hyperlink{namespace_utilities_a512d73667d76a5a58e44042a4a73c974}{contour\_center}}(std::vector<RAY>\ \&P,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints);}
\DoxyCodeLine{00490\ }
...
\DoxyCodeLine{00688\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_utilities_1_1_interpolator_aa5194f7e3a272f7b294d1f6fffe18566}{Interpolator}}\{}
...
\DoxyCodeLine{00814\ \ \ \ \ fx\ =\ ((x[0]\ -\/\ center[0])/range\ +\ 0.5)*(N-\/1);}
...
\DoxyCodeLine{00829\ \ \ \ \ }
\DoxyCodeLine{00831\ \ \ \ \ fx\ =\ center[0]\ +\ range*(\ 1.0*(ix)/(N-\/1)\ -\/\ 0.5\ );}
\DoxyCodeLine{00832\ \ \ \ \ fy\ =\ center[1]\ +\ range\_y*(\ 1.0*(iy)/(Ny-\/1)\ -\/\ 0.5\ );}
\DoxyCodeLine{00833\ \ \ \ \ fx=(x[0]\ -\/\ fx)*(N-\/1)/range;}
...
\DoxyCodeLine{00860\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{float}\ isLeft(\ Point\ *p0,\ Point\ *p1,\ PosType\ *x\ )\{}
\DoxyCodeLine{00861\ \ \ }
\DoxyCodeLine{00862\ \ \ \textcolor{keywordflow}{return}\ (p1-\/>x[0]\ -\/\ p0-\/>x[0])*(x[1]\ -\/\ p0-\/>x[1])}
\DoxyCodeLine{00863\ \ \ -\/\ (x[0]\ -\/\ p0-\/>x[0])*(p1-\/>x[1]\ -\/\ p0-\/>x[1]);}
\DoxyCodeLine{00864\ \};}
\DoxyCodeLine{00865\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{float}\ isLeft(\textcolor{keyword}{const}\ Point\_2d\ \&p0,\textcolor{keyword}{const}\ Point\_2d\ \&p1,\textcolor{keyword}{const}\ Point\_2d\ \&x\ )\{}
...
\DoxyCodeLine{00869\ }
\DoxyCodeLine{00870\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespace_utilities_ac42846299720c47decf597f70d448464}{windings}}(PosType\ *x,Point\ *points,\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints,PosType\ *area,\textcolor{keywordtype}{short}\ image\ =\ 0\ );}
\DoxyCodeLine{00871\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespace_utilities_ac42846299720c47decf597f70d448464}{windings}}(PosType\ *x,Point\ **points,\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints,PosType\ *area,\textcolor{keywordtype}{short}\ image\ =\ 0\ );}
\DoxyCodeLine{00872\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespace_utilities_ac42846299720c47decf597f70d448464}{windings}}(\textcolor{keyword}{const}\ Point\_2d\ \&x,\textcolor{keyword}{const}\ std::vector<Point\_2d>\ \&point,PosType\ *area);}
\DoxyCodeLine{00873\ \textcolor{comment}{//\ this\ is\ for\ the\ image\ postions}}
\DoxyCodeLine{00874\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespace_utilities_ac42846299720c47decf597f70d448464}{windings}}(Point\_2d\ \&x,std::vector<RAY>\ \&point,PosType\ *area);}
...
\DoxyCodeLine{00876\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespace_utilities_a70de03dea8a3f77f15fd209a783a8065}{windings2}}(PosType\ *x,Point\ *points,\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ Npoints,PosType\ *area,\textcolor{keywordtype}{short}\ image);}
\DoxyCodeLine{00878\ }
\DoxyCodeLine{00879\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ \mbox{\hyperlink{namespace_utilities_af2fb3cc522fc36c51e33bccac70089c7}{order\_curve4}}(Point\ *curve,\textcolor{keywordtype}{long}\ Npoints);}
\DoxyCodeLine{00880\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ \mbox{\hyperlink{namespace_utilities_af2fb3cc522fc36c51e33bccac70089c7}{order\_curve4}}(Kist<Point>\ *\ curve);}
\DoxyCodeLine{00881\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ \mbox{\hyperlink{namespace_utilities_ad8293f72cb05db408c84e3d101a56e41}{order\_curve5}}(Kist<Point>\ *\ curve);}
\DoxyCodeLine{00882\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespace_utilities_a742ad22484d4cfaaefd6317d73a74934}{ordered\_convexhull}}(Kist<Point>\ *\ curve);}
\DoxyCodeLine{00883\ \textcolor{keywordtype}{void}\ ordered\_shrink\_wrap(Kist<Point>\ *\ curve);}
\DoxyCodeLine{00884\ \textcolor{keywordtype}{void}\ ordered\_concavehull(Kist<Point>\ *\ curve);}
\DoxyCodeLine{00885\ PosType\ \mbox{\hyperlink{namespace_utilities_a865c4f1f38a91d8b3d4e07fdfea16bd0}{ConvexHullArea}}(Kist<Point>\ *\ curve);}
\DoxyCodeLine{00886\ }
\DoxyCodeLine{00887\ }
\DoxyCodeLine{00888\ \}}
\DoxyCodeLine{00889\ \textcolor{comment}{//\ in\ curve\_routines.c}}
\DoxyCodeLine{00890\ \textcolor{comment}{//void\ nesting\_curve(OldImageInfo\ *curves,int\ Ncurves);}}
\DoxyCodeLine{00891\ \textcolor{comment}{//void\ split\_order\_curve(OldImageInfo\ *curves,int\ Maxcurves,int\ *Ncurves);}}
\DoxyCodeLine{00892\ \textcolor{comment}{//void\ split\_order\_curve2(OldImageInfo\ *curves,int\ Maxcurves,int\ *Ncurves);}}
\DoxyCodeLine{00893\ \textcolor{comment}{//void\ split\_order\_curve3(OldImageInfo\ *curves,int\ Maxcurves,int\ *Ncurves);}}
\DoxyCodeLine{00894\ \textcolor{comment}{//void\ split\_order\_curve4(OldImageInfo\ *curves,int\ Maxcurves,int\ *Ncurves);}}
\DoxyCodeLine{00895\ }
\DoxyCodeLine{00896\ \textcolor{keywordtype}{bool}\ order\_ExteriorBoundary(\mbox{\hyperlink{struct_point}{Point}}\ *curve,\textcolor{keywordtype}{long}\ Npoints,\textcolor{keywordtype}{long}\ *NewNpoints,PosType\ *area);}
\DoxyCodeLine{00897\ PosType\ findAreaOfCurve(TreeHndl\ tree,\mbox{\hyperlink{struct_image_info}{ImageInfo}}\ *curve,\textcolor{keywordtype}{int}\ NimageMax);}
\DoxyCodeLine{00898\ \textcolor{keywordtype}{void}\ walkcurve(\mbox{\hyperlink{struct_point}{Point}}\ *points,\textcolor{keywordtype}{long}\ Npoints,\textcolor{keywordtype}{long}\ *j,\textcolor{keywordtype}{long}\ *end);}
\DoxyCodeLine{00899\ \textcolor{keywordtype}{void}\ walkcurveRight(\mbox{\hyperlink{struct_point}{Point}}\ *points,\textcolor{keywordtype}{long}\ Npoints,\textcolor{keywordtype}{long}\ *j,\textcolor{keywordtype}{long}\ *end);}
\DoxyCodeLine{00900\ \textcolor{keywordtype}{short}\ backtrack(\mbox{\hyperlink{struct_point}{Point}}\ *points,\textcolor{keywordtype}{long}\ Npoints,\textcolor{keywordtype}{long}\ *j,\textcolor{keywordtype}{long}\ jold,\textcolor{keywordtype}{long}\ *end);}
\DoxyCodeLine{00901\ \textcolor{keywordtype}{void}\ split\_images(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_image_info}{ImageInfo}}\ *images,\textcolor{keywordtype}{int}\ Maximages,\textcolor{keywordtype}{int}\ *Nimages,\textcolor{keywordtype}{bool}\ sortallpoints);}
\DoxyCodeLine{00902\ \textcolor{keywordtype}{void}\ split\_images2(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_image_info}{ImageInfo}}\ *images,\textcolor{keywordtype}{int}\ Maximages,\textcolor{keywordtype}{int}\ *Nimages);}
\DoxyCodeLine{00903\ \textcolor{keywordtype}{void}\ split\_images3(TreeHndl\ i\_tree,\mbox{\hyperlink{struct_image_info}{ImageInfo}}\ *images,\textcolor{keywordtype}{int}\ Maximages,\textcolor{keywordtype}{int}\ *Nimages,\textcolor{keywordtype}{bool}\ sortallpoints);}
\DoxyCodeLine{00904\ \textcolor{comment}{//void\ splitter(OldImageInfo\ *images,int\ Maximages,int\ *Nimages);}}
\DoxyCodeLine{00905\ \textcolor{keywordtype}{void}\ splitlist(ListHndl\ imagelist,\mbox{\hyperlink{struct_old_image_info}{OldImageInfo}}\ *images,\textcolor{keywordtype}{int}\ *Nimages,\textcolor{keywordtype}{int}\ Maximages);}
\DoxyCodeLine{00906\ }
\DoxyCodeLine{00907\ }
\DoxyCodeLine{00908\ \textcolor{comment}{/*\ externally\ provided\ functions\ */}}
\DoxyCodeLine{00909\ \textcolor{comment}{/*********************************/}}
\DoxyCodeLine{00910\ }
\DoxyCodeLine{00911\ \textcolor{comment}{//void\ rayshooterInternal(unsigned\ long\ Npoints,Point\ *i\_points);}}
\DoxyCodeLine{00912\ \textcolor{keywordtype}{void}\ in\_source(PosType\ *y\_source,ListHndl\ sourcelist);}
\DoxyCodeLine{00913\ \textcolor{keywordtype}{bool}\ tree\_count\_test(TreeHndl\ tree);}
\DoxyCodeLine{00914\ \textcolor{keywordtype}{bool}\ testLeafs(TreeHndl\ tree);}
\DoxyCodeLine{00915\ }
\DoxyCodeLine{00916\ \textcolor{keywordtype}{void}\ NeighborsOfNeighbors(ListHndl\ neighbors,ListHndl\ wholelist);}
\DoxyCodeLine{00917\ }
